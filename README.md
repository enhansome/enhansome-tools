...
虽然已经有很多 [Awesome List](https://github.com/sindresorhus/awesome#readme) ⭐ 500,829 | 🐛 105 | 📅 2026-08-21，但是太多了，找起来很不方便，还是整理一份自己的。
...
* [keycloak/keycloak](https://github.com/keycloak/keycloak) ⭐ 36,471 | 🐛 3,150 | 🌐 Java | 📅 2026-08-28 - Open Source Identity and Access Management For Modern Applications and Services
* [authelia/authelia](https://github.com/authelia/authelia) ⭐ 28,731 | 🐛 132 | 🌐 Go | 📅 2026-08-28 - The Single Sign-On Multi-Factor portal for web apps
* [goauthentik/authentik](https://github.com/goauthentik/authentik) ⭐ 25,218 | 🐛 1,068 | 🌐 Python | 📅 2026-08-28 - The authentication glue you need.
* [ory/hydra](https://github.com/ory/hydra#what-is-ory-hydra) ⭐ 17,510 | 🐛 94 | 🌐 Go | 📅 2026-07-29 - OpenID Certified™ OpenID Connect and OAuth Provider written in Go - cloud native, security-first, open source API security for your infrastructure. SDKs for any language. Works with Hardware Security Modules. Compatible with MITREid.
* [oauth2-proxy/oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) ⭐ 14,889 | 🐛 254 | 🌐 Go | 📅 2026-08-28 - A reverse proxy that provides authentication with Google, Azure, OpenID Connect and many more identity providers.
* [zitadel/zitadel](https://github.com/zitadel/zitadel) ⭐ 14,887 | 🐛 1,139 | 🌐 Go | 📅 2026-08-28 - ZITADEL - The best of Auth0 and Keycloak combined. Built for the serverless era.
* [logto-io/logto](https://github.com/logto-io/logto) ⭐ 14,476 | 🐛 178 | 🌐 TypeScript | 📅 2026-08-28 - Logto helps you build the sign-in, auth, and user identity within minutes. We provide an OIDC-based identity service and the end-user experience with username, phone number, email, and social sign-in, for web and native apps.
* [casdoor/casdoor](https://github.com/casdoor/casdoor) ⭐ 14,286 | 🐛 116 | 🌐 Go | 📅 2026-08-28 - An open-source Identity and Access Management (IAM) / Single-Sign-On (SSO) platform with web UI supporting OAuth 2.0, OIDC, SAML and CAS
* [ory/kratos](https://github.com/ory/kratos) ⭐ 13,855 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication.
* [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,069 | 🐛 535 | 🌐 Go | 📅 2026-08-24 - OpenID Connect (OIDC) identity and OAuth 2.0 provider with pluggable connectors
...
* [netlify/gotrue](https://github.com/netlify/gotrue) ⭐ 4,465 | 🐛 14 | 🌐 Go | 📅 2026-07-24 - An SWT based API for managing users and issuing SWT tokens
...
* [just](https://github.com/casey/just) ⭐ 35,529 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - 类似 make。
* [invoke](https://github.com/pyinvoke/invoke) ⭐ 4,769 | 🐛 460 | 🌐 Python | 📅 2026-04-07 - Pythonic task management & command execution.
...
* [kopia/kopia](https://github.com/kopia/kopia) ⭐ 13,977 | 🐛 873 | 🌐 Go | 📅 2026-08-25 - Cross-platform backup tool for Windows, macOS & Linux with fast, incremental backups, client-side end-to-end encryption, compression and data deduplication. CLI and GUI included.
* [BorgBackup](https://www.borgbackup.org/) - [开源](https://github.com/borgbackup/borg) ⭐ 13,660 | 🐛 227 | 🌐 Python | 📅 2026-08-28 备份软件，强烈推荐。
* [bup/bup](https://github.com/bup/bup) ⭐ 7,340 | 🐛 17 | 🌐 Python | 📅 2026-08-22 - Very efficient backup system based on the git packfile format, providing fast incremental saves and global deduplication (among and within files, including virtual machine images).
...
* [cupcakearmy/autorestic](https://github.com/cupcakearmy/autorestic) ⭐ 1,858 | 🐛 103 | 🌐 Go | 📅 2026-04-05 - Config driven, easy backup cli for restic.
...
* [Teleport](https://goteleport.com/) - [开源](https://github.com/gravitational/teleport) ⭐ 20,857 | 🐛 3,331 | 🌐 Go | 📅 2026-08-28。
...
* [shellhub-io/shellhub](https://github.com/shellhub-io/shellhub) ⭐ 2,063 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-28 - Get seamless remote access to any Linux device. Centralized SSH for the edge and cloud computing
* [moul/sshportal](https://github.com/moul/sshportal) ⭐ 1,940 | 🐛 81 | 🌐 Go | 📅 2026-08-28 - simple, fun and transparent SSH (and telnet) bastion server
...
* [rTorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,850 | 🐛 398 | 🌐 C++ | 📅 2026-08-28
* [rutorrent](https://github.com/Novik/ruTorrent) ⭐ 2,176 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-28 - rTorrent 的 Web 管理界面，配合 RSS 插件挂 PT。
...
* [cheat.sh](https://cheat.sh) - [开源](https://github.com/chubin/cheat.sh) ⭐ 41,696 | 🐛 148 | 🌐 Python | 📅 2025-12-23。
* [navi](https://github.com/denisidoro/navi) ⭐ 17,492 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - Rust 写的。
* [cheat](https://github.com/cheat/cheat) ⭐ 13,440 | 🐛 34 | 🌐 Go | 📅 2026-05-19
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,467 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - [tldr](https://github.com/tldr-pages/tldr) ⭐ 63,513 | 🐛 300 | 🌐 Markdown | 📅 2026-08-28 的 Rust 实现。
...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,367 | 🐛 1,324 | 🌐 TypeScript | 📅 2026-08-28 - 很强大，公司内部的项目基本都在用这个做依赖的升级管理。
* [bundlesize](https://github.com/siddharthkp/bundlesize) ⭐ 4,474 | 🐛 83 | 🌐 JavaScript | 📅 2026-07-29
* [retire.js](https://github.com/RetireJS/retire.js) ⭐ 4,162 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-23
...
* [Dependabot](https://dependabot.com/) - 被 Github 收购了。
  * [dependabot-core](https://github.com/dependabot/dependabot-core) ⭐ 5,741 | 🐛 1,475 | 🌐 Ruby | 📅 2026-08-28
...
* [MEGAcmd](https://mega.nz/cmd) - Mega.nz 的官方 CLI，[开源](https://github.com/meganz/MEGAcmd) ⭐ 2,201 | 🐛 705 | 🌐 C++ | 📅 2026-08-28。
...
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,700 | 🐛 327 | 🌐 Go | 📅 2026-08-26 - 命令行下的模糊搜索工具，神器，我基于 fzf 写了 zsh 的 SSH [插件(zsh-ssh)](https://github.com/sunlei/zsh-ssh) ⭐ 218 | 🐛 0 | 🌐 Shell | 📅 2026-05-29。A command-line fuzzy finder.
* [BurntSushi/ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,675 | 🐛 183 | 🌐 Rust | 📅 2026-08-04 - ripgrep recursively searches directories for a regex pattern while respecting your gitignore
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,675 | 🐛 183 | 🌐 Rust | 📅 2026-08-04 - 比 grep 更好用。
* [bat](https://github.com/sharkdp/bat) ⭐ 60,287 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 - 支持高亮的 cat，我已经用来替换 cat。
* [sharkdp/bat](https://github.com/sharkdp/bat) ⭐ 60,287 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 - A cat(1) clone with wings.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,235 | 🐛 196 | 🌐 Rust | 📅 2026-08-28 - 加强版 find。
* [sharkdp/fd](https://github.com/sharkdp/fd) ⭐ 44,235 | 🐛 196 | 🌐 Rust | 📅 2026-08-28 - A simple, fast and user-friendly alternative to 'find'
* [nushell/nushell](https://github.com/nushell/nushell) ⭐ 40,357 | 🐛 1,433 | 🌐 Rust | 📅 2026-08-28 - A new type of shell
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,988 | 🐛 139 | 🌐 Rust | 📅 2026-08-28 - 智能化 cd。
* [casey/just](https://github.com/casey/just) ⭐ 35,529 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - 🤖 Just a command runner
* [zellij-org/zellij](https://github.com/zellij-org/zellij) ⭐ 35,158 | 🐛 1,874 | 🌐 Rust | 📅 2026-08-28 - A terminal workspace with batteries included
...
* [uutils/coreutils](https://github.com/uutils/coreutils) ⭐ 24,000 | 🐛 1,144 | 🌐 Rust | 📅 2026-08-28 - Cross-platform Rust rewrite of the GNU coreutils
* [neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived - 漂亮的系统信息获取工具。
* [eza-community/eza](https://github.com/eza-community/eza) ⭐ 23,070 | 🐛 438 | 🌐 Rust | 📅 2026-08-06 - A modern, maintained replacement for ls
* [rust-lang/mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,104 | 🐛 668 | 🌐 Rust | 📅 2026-08-28 - Create book from markdown files. Like Gitbook but implemented in Rust
* [fx](https://github.com/antonmedv/fx) ⭐ 20,602 | 🐛 26 | 🌐 Go | 📅 2026-08-26 - JSON 处理工具。
* [RustScan/RustScan](https://github.com/RustScan/RustScan) ⭐ 20,340 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - 🤖 The Modern Port Scanner 🤖
* [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,492 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [awscli](https://github.com/aws/aws-cli) ⭐ 17,227 | 🐛 723 | 🌐 Python | 📅 2026-08-28 - AWS 命令行工具。
...
* [Peltoche/lsd](https://github.com/Peltoche/lsd) ⭐ 16,199 | 🐛 205 | 🌐 Rust | 📅 2026-08-17 - The next gen ls command
...
* [XAMPPRocky/tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,856 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Count your code, quickly.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,498 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - JSON 查看工具。
* [Canop/broot](https://github.com/Canop/broot) ⭐ 12,921 | 🐛 231 | 🌐 Rust | 📅 2026-08-28 - A new way to see and navigate directory trees
* [gping](https://github.com/orf/gping) ⭐ 12,651 | 🐛 52 | 🌐 Rust | 📅 2026-08-24 - 可视化的 ping。
* [mas](https://github.com/mas-cli/mas) ⭐ 12,326 | 🐛 87 | 🌐 Swift | 📅 2026-08-25 - Mac App Store CLI.
...
* [kellyjonbrazil/jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,669 | 🐛 40 | 🌐 Python | 📅 2026-08-28 - CLI tool and python library that converts the output of popular command-line tools and file-types to JSON or Dictionaries. This allows piping of output to tools like jq and simplifying automation scripts.
...
* [Dotbot](https://github.com/anishathalye/dotbot) ⭐ 7,992 | 🐛 17 | 🌐 Python | 📅 2026-07-12 - dotfiles 管理工具，好用。
...
* [chmln/sd](https://github.com/chmln/sd) ⭐ 7,330 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - Intuitive find & replace CLI (sed alternative)
* [sd](https://github.com/chmln/sd) ⭐ 7,330 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - 加强版 sed。
...
* [watchexec/watchexec](https://github.com/watchexec/watchexec) ⭐ 7,145 | 🐛 28 | 🌐 Rust | 📅 2026-08-24 - Executes commands in response to file modifications
...
* [dog](https://dns.lookup.dog/) - 加强版的 dig，[开源](https://github.com/ogham/dog) ⭐ 6,689 | 🐛 79 | 🌐 Rust | 📅 2024-05-29。
* [sharkdp/pastel](https://github.com/sharkdp/pastel) ⭐ 6,472 | 🐛 38 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors
* [dbrgn/tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,467 | 🐛 14 | 🌐 Rust | 📅 2026-08-25 - A very fast implementation of tldr in Rust.
* [Byron/dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,184 | 🐛 27 | 🌐 Rust | 📅 2026-08-28 - View disk space usage and delete unwanted data, fast.
* [dalance/procs](https://github.com/dalance/procs) ⭐ 6,149 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust
* [procs](https://github.com/dalance/procs) ⭐ 6,149 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - 加强版 ps。
...
* [Aloxaf/silicon](https://github.com/Aloxaf/silicon) ⭐ 3,581 | 🐛 48 | 🌐 Rust | 📅 2024-09-26 - Create beautiful image of your source code.
...
* [ccat](https://github.com/owenthereal/ccat) ⭐ 3,208 | 🐛 41 | 🌐 Go | 📅 2022-09-05 - 支持高亮的 cat，更推荐 [bat](https://github.com/sharkdp/bat) ⭐ 60,287 | 🐛 424 | 🌐 Rust | 📅 2026-08-11。
...
* [rune-rs/rune](https://github.com/rune-rs/rune) ⭐ 2,315 | 🐛 66 | 🌐 Rust | 📅 2026-08-23 - An embeddable dynamic programming language for Rust.
...
* [bat-extras](https://github.com/eth-p/bat-extras) ⭐ 1,625 | 🐛 63 | 🌐 Shell | 📅 2025-02-22 - 基于 [bat](https://github.com/sharkdp/bat) ⭐ 60,287 | 🐛 424 | 🌐 Rust | 📅 2026-08-11 的几个工具。
...
* [aliyun-cli](https://github.com/aliyun/aliyun-cli) ⭐ 1,093 | 🐛 53 | 🌐 Go | 📅 2026-08-28 - 阿里云 CLI。
* [sentry-cli](https://github.com/getsentry/sentry-cli) ⭐ 1,038 | 🐛 97 | 🌐 Rust | 📅 2026-08-28 - [Sentry](https://sentry.io/) 的 CLI 工具。
...
* [nvchecker](https://github.com/lilydjwg/nvchecker) ⭐ 563 | 🐛 13 | 🌐 Python | 📅 2026-08-22 - 检查各种软件更新的工具，我 [添加](https://github.com/lilydjwg/nvchecker/pull/126) ⭐ 563 | 🐛 13 | 🌐 Python | 📅 2026-08-22 了 [Sparkle](https://sparkle-project.org/) 的支持后，配合 GitHub Actions 实现了 [更新通知服务](https://github.com/sunlei/nvchecker) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-28。
...
* [jhy/jsoup](https://github.com/jhy/jsoup/) ⭐ 11,387 | 🐛 5 | 🌐 Java | 📅 2026-08-26 - the Java HTML parser, built for HTML editing, cleaning, scraping, and XSS safety.
...
* [kislyuk/yq](https://github.com/kislyuk/yq) ⭐ 2,972 | 🐛 23 | 🌐 Python | 📅 2026-07-11 - Command-line YAML, XML, TOML processor - jq wrapper for YAML/XML/TOML documents
...
* [wtfutil/wtf](https://github.com/wtfutil/wtf) ⭐ 17,065 | 🐛 102 | 🌐 Go | 📅 2026-08-05 - The personal information dashboard for your terminal
...
* [uber/cadence](https://github.com/uber/cadence) ⭐ 9,422 | 🐛 199 | 🌐 Go | 📅 2026-08-28 - Cadence is a distributed, scalable, durable, and highly available orchestration engine to execute asynchronous long-running business logic in a scalable and resilient way.
* [gocron](https://github.com/ouqiang/gocron) ⭐ 6,263 | 🐛 165 | 🌐 Go | 📅 2024-03-27
* [Cronicle](https://github.com/jhuckaby/Cronicle) ⭐ 5,811 | 🐛 333 | 🌐 JavaScript | 📅 2026-08-28 - A simple, distributed task scheduler and runner with a web based UI.
...
* [Superset](https://superset.apache.org/) - [开源](https://github.com/apache/incubator-superset) ⭐ 74,515 | 🐛 609 | 🌐 Python | 📅 2026-08-28。
* [Metabase](https://metabase.com/) - [开源](https://github.com/metabase/metabase) ⭐ 48,980 | 🐛 4,461 | 🌐 Clojure | 📅 2026-08-28，跟 Redash、Superset 对比后，选用了这个。
...
* [Sequel Ace](https://sequel-ace.com/) - MySQL/MariaDB 图形工具，Sequel Pro 停止维护后， fork 出来继续维护的版本，[开源](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,521 | 🐛 174 | 🌐 Objective-C | 📅 2026-08-25。
...
* [man-group/ArcticDB](https://github.com/man-group/arcticdb) ⭐ 2,494 | 🐛 329 | 🌐 C++ | 📅 2026-08-28
...
* [scrcpy](https://github.com/Genymobile/scrcpy) ⭐ 148,449 | 🐛 2,884 | 🌐 C | 📅 2026-08-17 - Android 设备管理工具。
* [nvm](https://github.com/nvm-sh/nvm) ⭐ 94,770 | 🐛 396 | 🌐 Shell | 📅 2026-08-18 - Node.js 版本管理工具。
* [starship](https://starship.rs/) - 不错的 shell 提示符，用过一段时间，后来换到了 [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,986 | 🐛 150 | 🌐 Shell | 📅 2026-08-15。
* [wrk](https://github.com/wg/wrk) ⭐ 40,399 | 🐛 203 | 🌐 C | 📅 2023-12-30 - HTTP 压力测试。
* [DevDocs](https://devdocs.io/) - API 文档查看工具，[开源](https://github.com/freeCodeCamp/devdocs) ⭐ 39,384 | 🐛 217 | 🌐 Ruby | 📅 2026-08-26。
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,756 | 🐛 96 | 🌐 Rust | 📅 2026-04-30 - 命令行基准测试工具，测试不同命令的性能。
...
* [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,551 | 🐛 151 | 🌐 Go | 📅 2026-08-28 - 支持多种语言的版本管理工具。
...
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,474 | 🐛 27 | 🌐 Perl | 📅 2026-08-08 - 代码统计工具。
* [hey](https://github.com/rakyll/hey) ⭐ 20,245 | 🐛 189 | 🌐 Go | 📅 2026-01-10 - HTTP 压力测试工具。
* [SwiftLint](https://github.com/realm/SwiftLint) ⭐ 19,714 | 🐛 496 | 🌐 Swift | 📅 2026-08-28 - Swift lint 工具。
* [n](https://github.com/tj/n) ⭐ 19,510 | 🐛 5 | 🌐 Shell | 📅 2026-08-28 - Node.js 版本管理工具。
...
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,856 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - 代码统计工具。
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,098 | 🐛 126 | 🌐 Go | 📅 2026-08-05 - 方便的创建 webhook endpoints，自己基于这个实现了 GitLab 和 Jira 的 bot。
* [npm-check-updates](https://github.com/raineorshine/npm-check-updates) ⭐ 10,304 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-28 - npm 依赖更新检查工具。
* [scc](https://github.com/boyter/scc/) ⭐ 8,679 | 🐛 25 | 🌐 Go | 📅 2026-08-28 - 代码统计工具。
* [stow](https://www.gnu.org/software/stow/) - 文件链接管理工具，常用来管理 dotfiles，不过我更喜欢 [Dotbot](https://github.com/anishathalye/dotbot) ⭐ 7,992 | 🐛 17 | 🌐 Python | 📅 2026-07-12。
...
* [Ansible Molecule](https://github.com/ansible-community/molecule) ⭐ 4,134 | 🐛 79 | 🌐 Python | 📅 2026-08-28 - Ansible 开发/测试工具，非常好用。
...
* [copier](https://github.com/copier-org/copier) ⭐ 3,547 | 🐛 148 | 🌐 Python | 📅 2026-08-25 - Library and command-line utility for rendering projects templates. `Jinja2`
* [Conftest](https://github.com/open-policy-agent/conftest) ⭐ 3,252 | 🐛 51 | 🌐 Go | 📅 2026-08-25 - 配置检测工具，还未深入使用，参考 [Open Policy Agent](https://www.openpolicyagent.org/)。
* [yq](https://github.com/kislyuk/yq) ⭐ 2,972 | 🐛 23 | 🌐 Python | 📅 2026-07-11 - 命令行下的 YAML 和 XML 解析工具。
* [python-language-server](https://github.com/palantir/python-language-server) ⭐ 2,698 | 🐛 188 | 🌐 Python | 📅 2026-07-06 - Python 的 [Language Server Protocol](https://github.com/Microsoft/language-server-protocol) ⭐ 12,996 | 🐛 298 | 🌐 HTML | 📅 2026-08-26 实现。
...
* [gchq/CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,688 | 🐛 553 | 🌐 JavaScript | 📅 2026-08-28 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [veler/DevToys](https://github.com/veler/DevToys) ⭐ 31,902 | 🐛 339 | 🌐 C# | 📅 2026-02-25 - A Swiss Army knife for developers.
...
* [massCodeIO/massCode](https://github.com/massCodeIO/massCode) ⭐ 6,968 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-27 - A free and open source code snippets manager for developers
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,515 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - Docker 镜像分析工具，查看各层的信息。
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,645 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - 终端下的 Docker GUI。
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,678 | 🐛 258 | 🌐 Go | 📅 2026-08-28 - Docker 镜像安全检测工具。
...
* [CotEditor](https://coteditor.com/) - 文本编辑器，[开源](https://github.com/coteditor/CotEditor) ⭐ 8,423 | 🐛 16 | 🌐 Swift | 📅 2026-08-28。
...
* [age](https://github.com/FiloSottile/age) ⭐ 23,350 | 🐛 35 | 🌐 Go | 📅 2026-03-20 - A simple, modern and secure encryption tool (and Go library) with small explicit keys, no config options, and UNIX-style composability.
* [gocryptfs](https://github.com/rfjakob/gocryptfs) ⭐ 4,588 | 🐛 73 | 🌐 Go | 📅 2026-07-22 - Encrypted overlay filesystem written in Go
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,841 | 🐛 4 | 🌐 C | 📅 2026-08-26 - 终端下的文件管理器。
...
* [croc](https://github.com/schollz/croc) ⭐ 40,127 | 🐛 2 | 🌐 Go | 📅 2026-08-28 - 非常方便的临时文件传输工具，推荐。
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,695 | 🐛 258 | 🌐 C++ | 📅 2026-08-28
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,401 | 🐛 242 | 🌐 Python | 📅 2026-08-26 - Python 实现的，开源当包用，同时提供一个 watchmedo 的命令行工具。
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,145 | 🐛 28 | 🌐 Rust | 📅 2026-08-24
* [entr](http://eradman.com/entrproject/) - 文件变化监控工具，[开源](https://github.com/eradman/entr) ⭐ 5,661 | 🐛 1 | 🌐 C | 📅 2026-06-27。
...
* [Beancount](http://furius.ca/beancount/) - [开源](https://github.com/beancount/beancount) ⭐ 5,949 | 🐛 236 | 🌐 Python | 📅 2026-08-23 复式记账软件，强烈推荐。
...
* [Fira Code](https://github.com/tonsky/FiraCode) ⭐ 81,959 | 🐛 428 | 🌐 Clojure | 📅 2026-07-28
* [Fira Code Nerd Font](https://github.com/ryanoasis/nerd-fonts) ⭐ 64,445 | 🐛 20 | 🌐 CSS | 📅 2026-08-22
* [Hack Nerd Font](https://github.com/ryanoasis/nerd-fonts) ⭐ 64,445 | 🐛 20 | 🌐 CSS | 📅 2026-08-22
* [Meslo Nerd Font](https://github.com/ryanoasis/nerd-fonts) ⭐ 64,445 | 🐛 20 | 🌐 CSS | 📅 2026-08-22
* [Source Code Pro for Powerline](https://github.com/powerline/fonts/tree/master/SourceCodePro) ⭐ 26,325 | 🐛 185 | 🌐 Shell | 📅 2024-03-22
* [Source Code Pro](https://github.com/adobe-fonts/source-code-pro) ⭐ 20,440 | 🐛 86 | 🌐 CSS | 📅 2025-10-28
...
* [gomplate](https://github.com/hairyhenderson/gomplate) ⭐ 3,203 | 🐛 19 | 🌐 Go | 📅 2026-08-28 - A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,737 | 🐛 1,024 | 🌐 Go | 📅 2026-08-27 - 终端下的 Git GUI。
* [git-delta](https://github.com/dandavison/delta) ⭐ 31,902 | 🐛 429 | 🌐 Rust | 📅 2026-08-02 - git diff 加强。
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,444 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - 终端下的 Git GUI。
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,097 | 🐛 95 | 🌐 Shell | 📅 2026-08-27 - Git 的一些加强。
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,384 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Git 文件加密。
...
* [GitUp](https://gitup.co/) - Git GUI，[开源](https://github.com/git-up/GitUp) ⭐ 12,112 | 🐛 365 | 🌐 Objective-C | 📅 2026-07-27。
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,035 | 🐛 63 | 🌐 Rust | 📅 2026-08-28 - 漂亮的 Git 仓库信息统计。
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,877 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - Git 文件加密。
...
* [act](https://github.com/nektos/act) ⭐ 71,684 | 🐛 372 | 🌐 Go | 📅 2026-08-09 - 在本地执行 GitHub Actions，我之前用来开发 GitHub Actions。
* [gh](https://github.com/cli/cli) ⭐ 46,047 | 🐛 1,064 | 🌐 Go | 📅 2026-08-28 - GitHub CLI.
...
* [puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,515 | 🐛 263 | 🌐 TypeScript | 📅 2026-08-28 - Headless Chrome Node.js API
* [phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless Browser
* [appium](https://github.com/appium/appium) ⭐ 21,904 | 🐛 62 | 🌐 TypeScript | 📅 2026-08-28 - Automation for iOS, Android, and Windows Apps.
* [AutoHotkey\_L](https://github.com/Lexikos/AutoHotkey_L) ⭐ 13,024 | 🐛 22 | 🌐 C++ | 📅 2026-08-28 - AutoHotkey - macro-creation and automation-oriented scripting utility for Windows.
...
* [pyautogui](https://github.com/asweigart/pyautogui) ⭐ 12,669 | 🐛 584 | 🌐 Python | 📅 2024-08-20 - A cross-platform GUI automation Python module for human beings.
...
* [imgproxy/imgproxy](https://github.com/imgproxy/imgproxy) ⭐ 11,034 | 🐛 69 | 🌐 Go | 📅 2026-08-27 - Fast and secure standalone server for resizing and converting remote images
  ...
  * [benchmark](https://github.com/imgproxy/imgproxy/blob/master/BENCHMARK.md) ⭐ 11,034 | 🐛 69 | 🌐 Go | 📅 2026-08-27
  ...
  * [imazen/imageflow](https://github.com/imazen/imageflow) ⭐ 4,412 | 🐛 22 | 🌐 Rust | 📅 2026-08-27 - High-performance image manipulation for web servers. Includes imageflow\_server, imageflow\_tool, and libimageflow
  ...
  * [thumbor/thumbor](https://github.com/thumbor/thumbor) ⭐ 10,514 | 🐛 28 | 🌐 Python | 📅 2026-08-27 - thumbor is an open-source photo thumbnail service by globo.com
  * [webp-sh/webp\_server\_go](https://github.com/webp-sh/webp_server_go) ⭐ 2,008 | 🐛 1 | 🌐 Go | 📅 2026-08-28 - A tool that will serve your JPG/PNG/BMP/SVGs as WebP/AVIF format with compression, on-the-fly.
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,321 | 🐛 2,970 | 🌐 Go | 📅 2026-08-28
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,842 | 🐛 73 | 🌐 Go | 📅 2026-08-28
* [Minikube](https://github.com/kubernetes/minikube) ⭐ 32,074 | 🐛 540 | 🌐 Go | 📅 2026-08-28
...
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,455 | 🐛 207 | 🌐 Go | 📅 2026-08-28
...
* [stern](https://github.com/stern/stern) ⭐ 4,850 | 🐛 41 | 🌐 Go | 📅 2026-08-19 - Kubernetes 日志查看工具。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,551 | 🐛 105 | 🌐 Shell | 📅 2026-08-22
* [dehydrated](https://github.com/dehydrated-io/dehydrated) ⭐ 6,244 | 🐛 83 | 🌐 Shell | 📅 2026-04-30
* [Let's Encrypt](https://letsencrypt.org/)

## Linux/VPS Benchmarking

* [masonr/yet-another-bench-script](https://github.com/masonr/yet-another-bench-script) ⭐ 6,653 | 🐛 9 | 🌐 Shell | 📅 2026-07-28
...
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,100 | 🐛 225 | 🌐 Go | 📅 2026-08-16 - 命令行下的 Markdown 查看/渲染工具。
...
* [Downie](https://software.charliemonroe.net/downie/) - 视频下载工具，类似 [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,046 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19。
* [You-Get](https://github.com/soimort/you-get) ⭐ 56,870 | 🐛 386 | 🌐 Python | 📅 2026-08-24 - 视频下载工具。
* [IINA](https://iina.io/) - 视频播放器，[开源](https://github.com/iina/iina) ⭐ 46,121 | 🐛 1,917 | 🌐 Swift | 📅 2026-08-28，我记得是基于 mpv 的。
* [mpv](https://mpv.io/) - 视频播放器，[开源](https://github.com/mpv-player/mpv) ⭐ 36,721 | 🐛 1,143 | 🌐 C | 📅 2026-08-26，曾经花了很大精力去配置，后来换到了 IINA。
* [Annie](https://github.com/iawia002/annie) ⭐ 31,658 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - 视频下载工具。
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,345 | 🐛 1,150 | 🌐 Python | 📅 2026-08-01 - 相册服务下载工具。
...
* [Netdata](https://www.netdata.cloud/) - [开源](https://github.com/netdata/netdata) ⭐ 80,339 | 🐛 385 | 🌐 Go | 📅 2026-08-28 监控系统。
* [Stats](https://github.com/exelban/stats) ⭐ 41,486 | 🐛 25 | 🌐 Swift | 📅 2026-08-28 - 开源的系统监控工具，类似 iStat Menus。
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,928 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - 流量查看工具。
* [eul](https://github.com/gao-sun/eul) ⭐ 9,946 | 🐛 77 | 🌐 Swift | 📅 2024-05-25 - 开源的系统监控工具，类似 iStat Menus。
...
* [aristocratos/btop](https://github.com/aristocratos/btop) ⭐ 34,282 | 🐛 534 | 🌐 C++ | 📅 2026-08-26 - A monitor of resources
* [ClementTsang/bottom](https://github.com/clementtsang/bottom) ⭐ 13,946 | 🐛 108 | 🌐 Rust | 📅 2026-08-28 - Yet another cross-platform graphical process/system monitor.
* [aristocratos/bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,118 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 - Linux/OSX/FreeBSD resource monitor
* [aristocratos/bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,924 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/OSX/FreeBSD resource monitor
...
* [facebookincubator/below](https://github.com/facebookincubator/below) ⭐ 2,493 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
* [ytop](https://github.com/cjbassi/ytop) ⚠️ Archived - Rust 写的系统监控工具，类似 top、htop，不维护了。
* [Atoptool/atop](https://github.com/Atoptool/atop) ⭐ 1,055 | 🐛 62 | 🌐 C | 📅 2026-08-15 - System and process monitor for Linux
* [Glances](https://nicolargo.github.io/glances/) - 系统监控，类似 top/htop。
* [nmon and njmon](https://nmon.sourceforge.io/pmwiki.php)

## Music

* [navidrome/navidrome](https://github.com/navidrome/navidrome) ⭐ 23,177 | 🐛 274 | 🌐 Go | 📅 2026-08-28 - 🎧☁️ Modern Music Server and Streamer compatible with Subsonic/Airsonic
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,331 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - Rust 写的终端下的 Spotify 客户端。
...
* [harmonoid/harmonoid](https://github.com/harmonoid/harmonoid) ⭐ 4,715 | 🐛 89 | 🌐 Dart | 📅 2026-08-26 - 🎵 Plays & manages your music library. Looks beautiful & juicy. Playlists, visuals, synced lyrics, pitch shift, volume boost & more.
...
* [Motrix](https://motrix.app/) - 下载工具，基于 aria2，[开源](https://github.com/agalwood/Motrix) ⭐ 54,774 | 🐛 131 | 🌐 TypeScript | 📅 2026-08-28。
* [speedtest-cli](https://github.com/sivel/speedtest-cli) ⚠️ Archived - [Speedtest](https://www.speedtest.net/) 的命令行版。
* [AriaNg](https://github.com/mayswind/AriaNg) ⭐ 13,173 | 🐛 20 | 🌐 JavaScript | 📅 2026-06-21 - aria2 的 Web 管理工具
  * [AriaNg Native](https://github.com/mayswind/AriaNg-Native) ⭐ 2,717 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-21 - 基于 [Electron](https://github.com/electron/electron) ⭐ 122,769 | 🐛 753 | 🌐 C++ | 📅 2026-08-28 实现的 AriaNg 桌面版。
* [iperf3](https://github.com/esnet/iperf) ⭐ 8,721 | 🐛 233 | 🌐 C | 📅 2026-07-10 - 带宽测试工具。
* [Hackl0us/GeoIP2-CN](https://github.com/Hackl0us/GeoIP2-CN) ⭐ 7,411 | 🐛 32 | 🌐 Go | 📅 2026-08-28 - 最小巧、最准确、最实用的 中国大陆 IP 段 + GeoIP2 数据库。
* [Unbound](https://github.com/NLnetLabs/unbound) ⭐ 4,823 | 🐛 379 | 🌐 C | 📅 2026-08-26 - DNS 服务器，之前拿来在本机跑了一个优化的。
* [17mon/china\_ip\_list](https://github.com/17mon/china_ip_list) ⭐ 4,099 | 🐛 19 | 📅 2025-03-04 - IPList for China by IPIP.NET。
* [Aria2 Pro](https://github.com/P3TERX/Docker-Aria2-Pro) ⭐ 3,743 | 🐛 63 | 🌐 Dockerfile | 📅 2024-06-17 - 对 aria2 做了很多优化配置的 Docker 镜像，我在 seedbox 上跑了一个，本地通过 [AriaNg](https://github.com/mayswind/AriaNg) ⭐ 13,173 | 🐛 20 | 🌐 JavaScript | 📅 2026-06-21 来管理。
* [axel](https://github.com/axel-download-accelerator/axel) ⭐ 3,397 | 🐛 89 | 🌐 C | 📅 2026-08-27 - 多线程下载工具。
...
* [Joplin](https://joplinapp.org/) - 笔记工具，[开源](https://github.com/laurent22/joplin) ⭐ 56,139 | 🐛 619 | 🌐 TypeScript | 📅 2026-08-28。
...
* [novuhq/novu](https://github.com/novuhq/novu) ⭐ 39,681 | 🐛 104 | 🌐 TypeScript | 📅 2026-08-28 - `支持众多服务` The open-source notifications infrastructure. A fully-featured microservice to send SMS, E-mail, Slack and Push notifications. Embeddable notification center for React with real-time updates, content management, and much more...
* [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ⭐ 33,819 | 🐛 370 | 🌐 Go | 📅 2026-08-27 - `支持 Web APP、iOS、macOS` Send push notifications to your phone or desktop using PUT/POST
* [caronc/apprise](https://github.com/caronc/apprise) ⭐ 17,205 | 🐛 31 | 🌐 Python | 📅 2026-08-28 - `支持众多服务` Push Notifications that work with just about every platform!
* [Finb/Bark](https://github.com/Finb/Bark) ⭐ 8,958 | 🐛 6 | 🌐 Swift | 📅 2026-08-18 - `支持 iOS` Bark is an iOS App which allows you to push custom notifications to your iPhone
...
* [gopass](https://github.com/gopasspw/gopass) ⭐ 7,109 | 🐛 85 | 🌐 Go | 📅 2026-08-28 - 命令行下的密码管理工具。
...
* [Etherpad](https://etherpad.org/) - [ether/etherpad-lite](https://github.com/ether/etherpad-lite) ⭐ 18,512 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-28
* [PrivateBin](https://privatebin.info/) - [PrivateBin/PrivateBin](https://github.com/PrivateBin/PrivateBin) ⭐ 8,572 | 🐛 220 | 🌐 PHP | 📅 2026-08-26
* [CryptPad](https://cryptpad.fr/) - [xwiki-labs/cryptpad](https://github.com/xwiki-labs/cryptpad) ⭐ 7,869 | 🐛 391 | 🌐 JavaScript | 📅 2026-08-28
...
* [mattn/goreman](https://github.com/mattn/goreman) ⭐ 2,646 | 🐛 13 | 🌐 Go | 📅 2026-07-08 - foreman clone written in go language
...
* [brendangregg/FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,705 | 🐛 174 | 🌐 Perl | 📅 2024-10-20 - Stack trace visualizer
...
* [benfred/py-spy](https://github.com/benfred/py-spy) ⭐ 15,453 | 🐛 238 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs
...
* [wiretrustee/wiretrustee](https://github.com/wiretrustee/wiretrustee) ⭐ 28,704 | 🐛 1,578 | 🌐 Go | 📅 2026-08-28 - Connect your devices into a single secure private WireGuard®-based mesh network.
* [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,397 | 🐛 1 | 🌐 Shell | 📅 2026-08-27 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2
* [slackhq/nebula](https://github.com/slackhq/nebula) ⭐ 17,664 | 🐛 99 | 🌐 Go | 📅 2026-08-28 - A scalable overlay networking tool with a focus on performance, simplicity and security
* [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ⭐ 17,052 | 🐛 397 | 🌐 C++ | 📅 2026-08-03 - A Smart Ethernet Switch for Earth
...
* [firezone/firezone](https://github.com/firezone/firezone) ⭐ 9,045 | 🐛 401 | 🌐 Elixir | 📅 2026-08-28 - WireGuard-based VPN server and firewall
...
* [3proxy](https://github.com/z3APA3A/3proxy) ⭐ 5,425 | 🐛 34 | 🌐 C | 📅 2026-08-27
* [donaldzou/WGDashboard](https://github.com/donaldzou/WGDashboard) ⭐ 3,701 | 🐛 98 | 🌐 Vue | 📅 2026-08-24 - Simplest dashboard for WireGuard VPN written in Python w/ Flask
...
* [blackmatrix7/ios\_rule\_script](https://github.com/blackmatrix7/ios_rule_script) ⭐ 27,695 | 🐛 375 | 🌐 JavaScript | 📅 2026-08-28 - 除了整合各个开源的规则/脚本，也有很多特有的，大而全。
* [Hackl0us/SS-Rule-Snippet](https://github.com/Hackl0us/SS-Rule-Snippet) ⭐ 11,254 | 🐛 39 | 🌐 JavaScript | 📅 2024-03-19
...
* [pyenv](https://github.com/pyenv/pyenv) ⭐ 45,053 | 🐛 54 | 🌐 Shell | 📅 2026-08-28 - Python 版本管理工具。
...
* [Mypy](https://github.com/python/mypy) ⭐ 20,615 | 🐛 3,209 | 🌐 Python | 📅 2026-08-28 - Python 静态类型检查工具。
* [pipx](https://github.com/pipxproject/pipx) ⭐ 12,947 | 🐛 1 | 🌐 Python | 📅 2026-08-25 - 安装 Python 写的命令行工具的神器。
* [Bandit](https://github.com/PyCQA/bandit) ⭐ 8,245 | 🐛 260 | 🌐 Python | 📅 2026-08-24 - Python 代码安全检查。
...
* [black](https://github.com/psf/black) ⭐ 41,820 | 🐛 303 | 🌐 Python | 📅 2026-08-20
...
* [pip-tools](https://github.com/jazzband/pip-tools) ⭐ 8,008 | 🐛 173 | 🌐 Python | 📅 2026-08-22
...
* [dulwich](https://github.com/dulwich/dulwich) ⭐ 2,273 | 🐛 43 | 🌐 Python | 📅 2026-08-28 - Pure-Python Git implementation
...
* [atlassian-python-api](https://github.com/atlassian-api/atlassian-python-api) ⭐ 1,670 | 🐛 58 | 🌐 Python | 📅 2026-08-28 - 支持 Jira、Jira Service Desk、Confluence、BitBucket、Bamboo、Crowd。
...
* [robotframework](https://github.com/robotframework/robotframework) ⭐ 11,849 | 🐛 298 | 🌐 Python | 📅 2026-08-28
...
* [NetNewsWire](https://ranchero.com/netnewswire/) - 多平台 RSS 阅读工具，但是支持的服务比较少，[开源](https://github.com/Ranchero-Software/NetNewsWire) ⭐ 10,329 | 🐛 618 | 🌐 Swift | 📅 2026-08-28。
* [Miniflux](https://miniflux.app/) - [开源](https://github.com/miniflux/v2) ⭐ 9,620 | 🐛 281 | 🌐 Go | 📅 2026-08-24 RSS 阅读服务。
...
* [MASSCAN](https://github.com/robertdavidgraham/masscan/) ⭐ 25,959 | 🐛 414 | 🌐 C | 📅 2026-04-23 - 端口快速扫描工具。
* [Ciphey](https://github.com/Ciphey/Ciphey) ⭐ 21,582 | 🐛 0 | 🌐 Rust | 📅 2026-08-26 - 使用自然语言处理和人工智能以及一些全自动解密/解码/破解工具。
* [JD-GUI](https://java-decompiler.github.io/) - Java 反编译工具，[开源](https://github.com/java-decompiler/jd-gui) ⭐ 15,182 | 🐛 248 | 🌐 Java | 📅 2024-07-08。
* [OWASP Amass](https://github.com/OWASP/Amass) ⭐ 15,057 | 🐛 239 | 🌐 Go | 📅 2026-07-19 - 安全测试信息收集工具。
* [hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,210 | 🐛 49 | 🌐 C | 📅 2026-07-30 - 密码破解。
* [YARA](https://github.com/VirusTotal/yara/) ⭐ 9,836 | 🐛 170 | 🌐 C | 📅 2026-08-25 - 恶意软件查找。
* [objection](https://github.com/sensepost/objection) ⭐ 9,350 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - 基于 [Frida](https://frida.re/) 实现的移动端安全测试辅助工具。
...
* [assh](https://github.com/moul/assh) ⭐ 3,219 | 🐛 100 | 🌐 Go | 📅 2026-08-28 - SSH 客户端加强。
...
* [celery/celery](https://github.com/celery/celery) ⭐ 28,835 | 🐛 756 | 🌐 Python | 📅 2026-08-27 - Distributed Task Queue (development branch)
* [rq/rq](https://github.com/rq/rq) ⭐ 10,672 | 🐛 253 | 🌐 Python | 📅 2026-08-24 - Simple job queues for Python
* [hatchet-dev/hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 7,807 | 🐛 139 | 🌐 Go | 📅 2026-08-28 - A distributed, fault-tolerant task queue
* [coleifer/huey](https://github.com/coleifer/huey) ⭐ 6,017 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - a little task queue for python
...
* [Terminus](https://eugeny.github.io/terminus/) - 终端模拟器，[开源](https://github.com/Eugeny/terminus) ⭐ 74,205 | 🐛 2,869 | 🌐 TypeScript | 📅 2026-08-28。
* [alacritty](https://github.com/alacritty/alacritty) ⭐ 65,543 | 🐛 338 | 🌐 Rust | 📅 2026-08-26 - A cross-platform, OpenGL terminal emulator.
* [tmux](https://github.com/tmux/tmux) ⭐ 48,881 | 🐛 34 | 🌐 C | 📅 2026-08-28 - 终端复用工具。
* [Hyper](https://hyper.is/) - 终端模拟器，基于 Electron，[开源](https://github.com/vercel/hyper) ⭐ 44,708 | 🐛 1,046 | 🌐 TypeScript | 📅 2026-08-21。
* [kitty](https://github.com/kovidgoyal/kitty) ⭐ 34,654 | 🐛 10 | 🌐 Python | 📅 2026-08-28 - Cross-platform, fast, feature-rich, GPU based terminal
* [Swordfish90/cool-retro-term](https://github.com/Swordfish90/cool-retro-term) ⭐ 25,962 | 🐛 561 | 🌐 QML | 📅 2026-05-31 - A good looking terminal emulator which mimics the old cathode display...
...
* [espanso](https://espanso.org/) - Rust 写的 [开源](https://github.com/federico-terzi/espanso) ⭐ 14,373 | 🐛 535 | 🌐 Rust | 📅 2026-08-24 跨平台文字快捷输入工具，类似 [aText](https://www.trankynam.com/atext/)、[TextExpander](https://textexpander.com/)。
...
* [muety/wakapi](https://github.com/muety/wakapi) ⭐ 4,412 | 🐛 38 | 🌐 Go | 📅 2026-08-27 - 📊 A minimalist, self-hosted WakaTime-compatible backend for coding statistics. 兼容 WakaTime，可自建。
...
* [traggo/server](https://github.com/traggo/server) ⭐ 1,623 | 🐛 62 | 🌐 Go | 📅 2026-07-31 - 开源可自建。
...
* [ActivityWatch](https://activitywatch.net/) - Open-source time tracker. 开源可自建。
  * [ActivityWatch/activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,736 | 🐛 183 | 🌐 Python | 📅 2026-08-26 - The best free and open-source automated time tracker. Cross-platform, extensible, privacy-focused.
...
* [kutt](https://github.com/thedevs-network/kutt) ⭐ 11,063 | 🐛 80 | 🌐 JavaScript | 📅 2026-08-17 - Free Modern URL Shortener.
...
* [zws](https://github.com/zws-im/zws) ⭐ 1,847 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-28 - Shorten URLs using invisible spaces.
...
* [YOURLS](https://yourls.org/) - Your Own URL Shortener
  * [YOURLS](https://github.com/YOURLS/YOURLS) ⭐ 12,179 | 🐛 49 | 🌐 PHP | 📅 2026-08-28

## Utilities

* [Etcher](https://www.balena.io/etcher/) - 往 U 盘写入镜像的工具，[开源](https://github.com/balena-io/etcher) ⭐ 34,252 | 🐛 688 | 🌐 TypeScript | 📅 2026-06-02。
* [PicGo](https://molunerfinn.com/PicGo/) - 支持各种图床的上传工具，基于 Electron，[开源](https://github.com/Molunerfinn/PicGo) ⭐ 27,073 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-23。
* [Background Music](https://github.com/kyleneideck/BackgroundMusic) ⭐ 19,254 | 🐛 540 | 🌐 C++ | 📅 2026-06-10 - macOS 下独立控制各应用的声音。
* [Quick Look plugins](https://github.com/sindresorhus/quick-look-plugins) ⭐ 18,750 | 🐛 4 | 📅 2026-07-25 - 一系列 Quick Look 插件。
* [KeyCastr](https://github.com/keycastr/keycastr) ⭐ 15,073 | 🐛 89 | 🌐 Objective-C | 📅 2026-08-27 - 显示当前按键。
...
* [Bob](https://github.com/ripperhe/Bob) ⭐ 9,737 | 🐛 108 | 📅 2025-12-30 - macOS 下的翻译软件。
...
* [ai/nanoid](https://github.com/ai/nanoid) ⭐ 26,953 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10 - A tiny (130 bytes), secure, URL-friendly, unique string ID generator for JavaScript
...
* [python-visualization/folium](https://github.com/python-visualization/folium) ⭐ 7,394 | 🐛 70 | 🌐 Python | 📅 2026-08-28 - Python Data. Leaflet.js Maps.
* [tidyverse/ggplot2](https://github.com/tidyverse/ggplot2) ⭐ 6,989 | 🐛 147 | 🌐 R | 📅 2026-04-22 - An implementation of the Grammar of Graphics in R
...
* [holoviz/holoviews](https://github.com/holoviz/holoviews) ⭐ 2,907 | 🐛 1,053 | 🌐 Python | 📅 2026-08-28 - With Holoviews, your data visualizes itself.
...
* [holoviz/hvplot](https://github.com/holoviz/hvplot) ⭐ 1,357 | 🐛 397 | 🌐 Python | 📅 2026-08-24 - A high-level plotting API for pandas, dask, xarray, and networkx built on HoloViews
...
* [umami](https://github.com/umami-software/umami) ⭐ 38,423 | 🐛 113 | 🌐 TypeScript | 📅 2026-08-27 - Umami is a simple, fast, privacy-focused alternative to Google Analytics.
* [arp242/goatcounter](https://github.com/arp242/goatcounter) ⭐ 5,919 | 🐛 48 | 🌐 Go | 📅 2026-08-21 - Easy web analytics. No tracking of personal data.
...
* [n8n](https://github.com/n8n-io/n8n) ⭐ 202,706 | 🐛 1,115 | 🌐 TypeScript | 📅 2026-08-28 - 支持的 [服务](https://n8n.io/integrations)。
* [Huginn](https://github.com/huginn/huginn) ⭐ 49,863 | 🐛 695 | 🌐 Ruby | 📅 2026-08-28
* [windmill-labs/windmill](https://github.com/windmill-labs/windmill) ⭐ 17,709 | 🐛 832 | 🌐 Rust | 📅 2026-08-28 - Open-source developer platform to turn scripts into workflows and UIs. Fastest workflow engine (5x vs Airflow). Open-source alternative to Airplane and Retool.
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream) ⭐ 11,652 | 🐛 4,368 | 🌐 JavaScript | 📅 2026-08-28 - Connect APIs, remarkably fast. Free for developers.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,986 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - zsh theme，很好用，特别是`Instant prompt`这个特性，我从 [starship](https://starship.rs/) 转过来的。
* [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ⭐ 36,016 | 🐛 203 | 🌐 Shell | 📅 2025-06-24
...
* [Zinit](https://github.com/zdharma-continuum/zinit) ⭐ 4,817 | 🐛 111 | 🌐 Shell | 📅 2026-08-28 - zsh 插件管理工具，很好用，特别是`Turbo Mode`这个特性，[Antibody](https://github.com/getantibody/antibody) ⚠️ Archived 转过来的。
* [zsh-history-substring-search](https://github.com/zsh-users/zsh-history-substring-search) ⭐ 3,093 | 🐛 46 | 🌐 Shell | 📅 2026-01-15
* [Antibody](https://github.com/getantibody/antibody) ⚠️ Archived - zsh 插件管理工具，用过一段时间，后来换 [Zinit](https://github.com/zdharma-continuum/zinit) ⭐ 4,817 | 🐛 111 | 🌐 Shell | 📅 2026-08-28 了。
