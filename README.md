...
虽然已经有很多 [Awesome List](https://github.com/sindresorhus/awesome#readme) ⭐ 500,495 | 🐛 105 | 📅 2026-08-21，但是太多了，找起来很不方便，还是整理一份自己的。
...
* [authelia/authelia](https://github.com/authelia/authelia) ⭐ 28,719 | 🐛 132 | 🌐 Go | 📅 2026-08-27 - The Single Sign-On Multi-Factor portal for web apps
* [goauthentik/authentik](https://github.com/goauthentik/authentik) ⭐ 25,193 | 🐛 1,066 | 🌐 Python | 📅 2026-08-27 - The authentication glue you need.
* [ory/hydra](https://github.com/ory/hydra#what-is-ory-hydra) ⭐ 17,503 | 🐛 93 | 🌐 Go | 📅 2026-07-29 - OpenID Certified™ OpenID Connect and OAuth Provider written in Go - cloud native, security-first, open source API security for your infrastructure. SDKs for any language. Works with Hardware Security Modules. Compatible with MITREid.
* [oauth2-proxy/oauth2-proxy](https://github.com/oauth2-proxy/oauth2-proxy) ⭐ 14,882 | 🐛 252 | 🌐 Go | 📅 2026-08-27 - A reverse proxy that provides authentication with Google, Azure, OpenID Connect and many more identity providers.
* [zitadel/zitadel](https://github.com/zitadel/zitadel) ⭐ 14,878 | 🐛 1,140 | 🌐 Go | 📅 2026-08-27 - ZITADEL - The best of Auth0 and Keycloak combined. Built for the serverless era.
* [logto-io/logto](https://github.com/logto-io/logto) ⭐ 14,474 | 🐛 182 | 🌐 TypeScript | 📅 2026-08-27 - Logto helps you build the sign-in, auth, and user identity within minutes. We provide an OIDC-based identity service and the end-user experience with username, phone number, email, and social sign-in, for web and native apps.
* [casdoor/casdoor](https://github.com/casdoor/casdoor) ⭐ 14,281 | 🐛 109 | 🌐 Go | 📅 2026-08-27 - An open-source Identity and Access Management (IAM) / Single-Sign-On (SSO) platform with web UI supporting OAuth 2.0, OIDC, SAML and CAS
* [ory/kratos](https://github.com/ory/kratos) ⭐ 13,851 | 🐛 222 | 🌐 Go | 📅 2026-07-29 - Next-gen identity server (think Auth0, Okta, Firebase) with Ory-hardened authentication.
* [dexidp/dex](https://github.com/dexidp/dex) ⭐ 11,067 | 🐛 531 | 🌐 Go | 📅 2026-08-24 - OpenID Connect (OIDC) identity and OAuth 2.0 provider with pluggable connectors
* [pomerium/pomerium](https://github.com/pomerium/pomerium) ⭐ 4,979 | 🐛 153 | 🌐 Go | 📅 2026-08-27 - Pomerium is an identity and context-aware access proxy.
...
* [cloudfoundry/uaa](https://github.com/cloudfoundry/uaa) ⭐ 1,638 | 🐛 52 | 🌐 Java | 📅 2026-08-27 - CloudFoundry User Account and Authentication (UAA) Server
...
* [just](https://github.com/casey/just) ⭐ 35,518 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - 类似 make。
...
* [kopia/kopia](https://github.com/kopia/kopia) ⭐ 13,974 | 🐛 870 | 🌐 Go | 📅 2026-08-25 - Cross-platform backup tool for Windows, macOS & Linux with fast, incremental backups, client-side end-to-end encryption, compression and data deduplication. CLI and GUI included.
* [BorgBackup](https://www.borgbackup.org/) - [开源](https://github.com/borgbackup/borg) ⭐ 13,658 | 🐛 225 | 🌐 Python | 📅 2026-08-27 备份软件，强烈推荐。
...
* [Vorta](https://vorta.borgbase.com/) - Borg Backup 的图形化客户端，[开源](https://github.com/borgbase/vorta) ⭐ 2,500 | 🐛 234 | 🌐 Python | 📅 2026-08-25。
...
* [restic/rest-server](https://github.com/restic/rest-server) ⭐ 1,489 | 🐛 63 | 🌐 Go | 📅 2026-07-22 - Rest Server is a high performance HTTP server that implements restic's REST backend API.
* [creativeprojects/resticprofile](https://github.com/creativeprojects/resticprofile) ⭐ 1,401 | 🐛 95 | 🌐 Go | 📅 2026-07-10 - Configuration profiles manager and scheduler for restic backup
...
* [knoxite/knoxite](https://github.com/knoxite/knoxite) ⭐ 492 | 🐛 50 | 🌐 Go | 📅 2023-08-29 - A data storage & backup system
...
* [Teleport](https://goteleport.com/) - [开源](https://github.com/gravitational/teleport) ⭐ 20,856 | 🐛 3,343 | 🌐 Go | 📅 2026-08-26。
...
* [shellhub-io/shellhub](https://github.com/shellhub-io/shellhub) ⭐ 2,063 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-27 - Get seamless remote access to any Linux device. Centralized SSH for the edge and cloud computing
...
* [rTorrent](https://github.com/rakshasa/rtorrent) ⭐ 4,850 | 🐛 400 | 🌐 C++ | 📅 2026-08-27
* [rutorrent](https://github.com/Novik/ruTorrent) ⭐ 2,176 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-27 - rTorrent 的 Web 管理界面，配合 RSS 插件挂 PT。
...
* [tldr](https://github.com/tldr-pages/tldr) ⭐ 63,500 | 🐛 290 | 🌐 Markdown | 📅 2026-08-27
* [cheat.sh](https://cheat.sh) - [开源](https://github.com/chubin/cheat.sh) ⭐ 41,694 | 🐛 148 | 🌐 Python | 📅 2025-12-23。
* [navi](https://github.com/denisidoro/navi) ⭐ 17,486 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - Rust 写的。
* [cheat](https://github.com/cheat/cheat) ⭐ 13,438 | 🐛 34 | 🌐 Go | 📅 2026-05-19
* [tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,467 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - [tldr](https://github.com/tldr-pages/tldr) ⭐ 63,500 | 🐛 290 | 🌐 Markdown | 📅 2026-08-27 的 Rust 实现。
...
* [semantic-release](https://github.com/semantic-release/semantic-release) ⭐ 24,009 | 🐛 404 | 🌐 JavaScript | 📅 2026-08-26
...
* [renovate](https://github.com/renovatebot/renovate) ⭐ 22,358 | 🐛 1,335 | 🌐 TypeScript | 📅 2026-08-27 - 很强大，公司内部的项目基本都在用这个做依赖的升级管理。
...
* [Dependabot](https://dependabot.com/) - 被 Github 收购了。
  * [dependabot-core](https://github.com/dependabot/dependabot-core) ⭐ 5,739 | 🐛 1,486 | 🌐 Ruby | 📅 2026-08-27
...
* [MEGAcmd](https://mega.nz/cmd) - Mega.nz 的官方 CLI，[开源](https://github.com/meganz/MEGAcmd) ⭐ 2,200 | 🐛 705 | 🌐 C++ | 📅 2026-04-14。
* [RsyncOSX](https://github.com/rsyncOSX/RsyncOSX) ⭐ 194 | 🐛 0 | 📅 2026-08-27 - rsync GUI.
...
* [The Fuck](https://github.com/nvbn/thefuck) ⭐ 97,747 | 🐛 455 | 🌐 Python | 📅 2024-07-19 - 帮你纠正命令的同时还能发泄下。
* [fzf](https://github.com/junegunn/fzf) ⭐ 82,682 | 🐛 326 | 🌐 Go | 📅 2026-08-26 - 命令行下的模糊搜索工具，神器，我基于 fzf 写了 zsh 的 SSH [插件(zsh-ssh)](https://github.com/sunlei/zsh-ssh) ⭐ 218 | 🐛 0 | 🌐 Shell | 📅 2026-05-29。A command-line fuzzy finder.
* [BurntSushi/ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,640 | 🐛 182 | 🌐 Rust | 📅 2026-08-04 - ripgrep recursively searches directories for a regex pattern while respecting your gitignore
* [ripgrep](https://github.com/BurntSushi/ripgrep) ⭐ 67,640 | 🐛 182 | 🌐 Rust | 📅 2026-08-04 - 比 grep 更好用。
* [bat](https://github.com/sharkdp/bat) ⭐ 60,278 | 🐛 422 | 🌐 Rust | 📅 2026-08-11 - 支持高亮的 cat，我已经用来替换 cat。
* [sharkdp/bat](https://github.com/sharkdp/bat) ⭐ 60,278 | 🐛 422 | 🌐 Rust | 📅 2026-08-11 - A cat(1) clone with wings.
...
* [fd](https://github.com/sharkdp/fd) ⭐ 44,220 | 🐛 192 | 🌐 Rust | 📅 2026-08-26 - 加强版 find。
...
* [zoxide](https://github.com/ajeetdsouza/zoxide) ⭐ 38,948 | 🐛 137 | 🌐 Rust | 📅 2026-08-24 - 智能化 cd。
* [casey/just](https://github.com/casey/just) ⭐ 35,518 | 🐛 171 | 🌐 Rust | 📅 2026-08-20 - 🤖 Just a command runner
* [zellij-org/zellij](https://github.com/zellij-org/zellij) ⭐ 35,148 | 🐛 1,870 | 🌐 Rust | 📅 2026-08-26 - A terminal workspace with batteries included
* [sharkdp/hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,751 | 🐛 96 | 🌐 Rust | 📅 2026-04-30 - A command-line benchmarking tool
...
* [uutils/coreutils](https://github.com/uutils/coreutils) ⭐ 23,996 | 🐛 1,151 | 🌐 Rust | 📅 2026-08-27 - Cross-platform Rust rewrite of the GNU coreutils
* [neofetch](https://github.com/dylanaraps/neofetch) ⚠️ Archived - 漂亮的系统信息获取工具。
* [eza-community/eza](https://github.com/eza-community/eza) ⭐ 23,059 | 🐛 438 | 🌐 Rust | 📅 2026-08-06 - A modern, maintained replacement for ls
* [rust-lang/mdBook](https://github.com/rust-lang/mdBook) ⭐ 22,102 | 🐛 678 | 🌐 Rust | 📅 2026-08-26 - Create book from markdown files. Like Gitbook but implemented in Rust
* [fx](https://github.com/antonmedv/fx) ⭐ 20,600 | 🐛 26 | 🌐 Go | 📅 2026-08-26 - JSON 处理工具。
* [RustScan/RustScan](https://github.com/RustScan/RustScan) ⭐ 20,337 | 🐛 61 | 🌐 Rust | 📅 2026-08-26 - 🤖 The Modern Port Scanner 🤖
* [denisidoro/navi](https://github.com/denisidoro/navi) ⭐ 17,486 | 🐛 113 | 🌐 Rust | 📅 2026-07-28 - An interactive cheatsheet tool for the command-line
* [awscli](https://github.com/aws/aws-cli) ⭐ 17,220 | 🐛 724 | 🌐 Python | 📅 2026-08-27 - AWS 命令行工具。
...
* [duf](https://github.com/muesli/duf) ⭐ 15,274 | 🐛 82 | 🌐 Go | 📅 2026-01-13 - 加强版 du。
* [muesli/duf](https://github.com/muesli/duf) ⭐ 15,274 | 🐛 82 | 🌐 Go | 📅 2026-01-13 - Disk Usage/Free Utility - a better 'df' alternative
* [XAMPPRocky/tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,855 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - Count your code, quickly.
* [gron](https://github.com/tomnomnom/gron) ⭐ 14,498 | 🐛 50 | 🌐 Go | 📅 2025-05-31 - JSON 查看工具。
* [Canop/broot](https://github.com/Canop/broot) ⭐ 12,918 | 🐛 231 | 🌐 Rust | 📅 2026-08-25 - A new way to see and navigate directory trees
* [gping](https://github.com/orf/gping) ⭐ 12,648 | 🐛 52 | 🌐 Rust | 📅 2026-08-24 - 可视化的 ping。
* [mas](https://github.com/mas-cli/mas) ⭐ 12,323 | 🐛 87 | 🌐 Swift | 📅 2026-08-25 - Mac App Store CLI.
* [bootandy/dust](https://github.com/bootandy/dust) ⭐ 12,190 | 🐛 8 | 🌐 Rust | 📅 2026-08-19 - A more intuitive version of du in rust
* [dust](https://github.com/bootandy/dust) ⭐ 12,190 | 🐛 8 | 🌐 Rust | 📅 2026-08-19 - 加强版 du，但我还是更喜欢 [ncdu](https://dev.yorhel.nl/ncdu)。
...
* [kellyjonbrazil/jc](https://github.com/kellyjonbrazil/jc) ⭐ 8,668 | 🐛 40 | 🌐 Python | 📅 2026-08-26 - CLI tool and python library that converts the output of popular command-line tools and file-types to JSON or Dictionaries. This allows piping of output to tools like jq and simplifying automation scripts.
* [pemistahl/grex](https://github.com/pemistahl/grex) ⭐ 8,175 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - A command-line tool and library for generating regular expressions from user-provided test cases
...
* [McFly](https://github.com/cantino/mcfly) ⭐ 7,781 | 🐛 136 | 🌐 Rust | 📅 2026-08-26 - Rust 写的 ctrl-r 加强工具。
* [aws-shell](https://aws.amazon.com/cli/) - AWS 命令行工具，[开源](https://github.com/awslabs/aws-shell) ⭐ 7,333 | 🐛 99 | 🌐 Python | 📅 2024-12-16。
* [chmln/sd](https://github.com/chmln/sd) ⭐ 7,328 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - Intuitive find & replace CLI (sed alternative)
* [sd](https://github.com/chmln/sd) ⭐ 7,328 | 🐛 77 | 🌐 Rust | 📅 2026-02-25 - 加强版 sed。
* [terminal-notifier](https://github.com/julienXX/terminal-notifier) ⭐ 7,298 | 🐛 7 | 🌐 Objective-C | 📅 2026-08-24 - 从终端发送通知，例如当耗时命令执行完毕后。
...
* [watchexec/watchexec](https://github.com/watchexec/watchexec) ⭐ 7,142 | 🐛 28 | 🌐 Rust | 📅 2026-08-24 - Executes commands in response to file modifications
...
* [sharkdp/pastel](https://github.com/sharkdp/pastel) ⭐ 6,469 | 🐛 38 | 🌐 Rust | 📅 2026-05-01 - A command-line tool to generate, analyze, convert and manipulate colors
* [dbrgn/tealdeer](https://github.com/dbrgn/tealdeer) ⭐ 6,467 | 🐛 15 | 🌐 Rust | 📅 2026-08-25 - A very fast implementation of tldr in Rust.
* [Byron/dua-cli](https://github.com/Byron/dua-cli) ⭐ 6,179 | 🐛 27 | 🌐 Rust | 📅 2026-08-25 - View disk space usage and delete unwanted data, fast.
* [dalance/procs](https://github.com/dalance/procs) ⭐ 6,147 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - A modern replacement for ps written in Rust
* [procs](https://github.com/dalance/procs) ⭐ 6,147 | 🐛 41 | 🌐 Rust | 📅 2026-08-17 - 加强版 ps。
...
* [TheWaWaR/simple-http-server](https://github.com/TheWaWaR/simple-http-server) ⭐ 3,460 | 🐛 43 | 🌐 Rust | 📅 2026-08-27 - Simple http server in Rust (Windows/Mac/Linux)
...
* [ccat](https://github.com/owenthereal/ccat) ⭐ 3,208 | 🐛 41 | 🌐 Go | 📅 2022-09-05 - 支持高亮的 cat，更推荐 [bat](https://github.com/sharkdp/bat) ⭐ 60,278 | 🐛 422 | 🌐 Rust | 📅 2026-08-11。
...
* [tbillington/kondo](https://github.com/tbillington/kondo) ⭐ 2,385 | 🐛 45 | 🌐 Rust | 📅 2026-04-24 - Save disk space by cleaning non-essential files from software projects.
* [rune-rs/rune](https://github.com/rune-rs/rune) ⭐ 2,313 | 🐛 66 | 🌐 Rust | 📅 2026-08-23 - An embeddable dynamic programming language for Rust.
...
* [grc](https://github.com/garabik/grc) ⭐ 2,191 | 🐛 95 | 🌐 Python | 📅 2024-08-18 - 让一些命令的输出变为彩色。
...
* [bat-extras](https://github.com/eth-p/bat-extras) ⭐ 1,625 | 🐛 63 | 🌐 Shell | 📅 2025-02-22 - 基于 [bat](https://github.com/sharkdp/bat) ⭐ 60,278 | 🐛 422 | 🌐 Rust | 📅 2026-08-11 的几个工具。
...
* [aliyun-cli](https://github.com/aliyun/aliyun-cli) ⭐ 1,091 | 🐛 52 | 🌐 Go | 📅 2026-08-27 - 阿里云 CLI。
* [sentry-cli](https://github.com/getsentry/sentry-cli) ⭐ 1,038 | 🐛 97 | 🌐 Rust | 📅 2026-08-27 - [Sentry](https://sentry.io/) 的 CLI 工具。
...
* [nvchecker](https://github.com/lilydjwg/nvchecker) ⭐ 563 | 🐛 13 | 🌐 Python | 📅 2026-08-22 - 检查各种软件更新的工具，我 [添加](https://github.com/lilydjwg/nvchecker/pull/126) ⭐ 563 | 🐛 13 | 🌐 Python | 📅 2026-08-22 了 [Sparkle](https://sparkle-project.org/) 的支持后，配合 GitHub Actions 实现了 [更新通知服务](https://github.com/sunlei/nvchecker) ⭐ 10 | 🐛 1 | 🌐 Dockerfile | 📅 2026-08-27。
...
* [Flarum](https://flarum.org/) - 用 PHP 实现的 [开源](https://github.com/flarum/flarum) ⭐ 16,383 | 🐛 1 | 🌐 PHP | 📅 2026-08-27 论坛程序。

## Cron Job

* [uber/cadence](https://github.com/uber/cadence) ⭐ 9,421 | 🐛 202 | 🌐 Go | 📅 2026-08-27 - Cadence is a distributed, scalable, durable, and highly available orchestration engine to execute asynchronous long-running business logic in a scalable and resilient way.
* [gocron](https://github.com/ouqiang/gocron) ⭐ 6,263 | 🐛 165 | 🌐 Go | 📅 2024-03-27
* [Cronicle](https://github.com/jhuckaby/Cronicle) ⭐ 5,811 | 🐛 333 | 🌐 JavaScript | 📅 2026-08-15 - A simple, distributed task scheduler and runner with a web based UI.
* [dkron](https://github.com/distribworks/dkron) ⭐ 4,731 | 🐛 41 | 🌐 Go | 📅 2026-08-27 - Dkron - Distributed, fault tolerant job scheduling system <https://dkron.io>
...
* [Free Cron Job Monitoring - Healthchecks.io](https://healthchecks.io/) - 开源。
  * [healthchecks/healthchecks](https://github.com/healthchecks/healthchecks/) ⭐ 10,289 | 🐛 53 | 🌐 Python | 📅 2026-08-27 - A cron monitoring tool written in Python & Django
...
* [Superset](https://superset.apache.org/) - [开源](https://github.com/apache/incubator-superset) ⭐ 74,488 | 🐛 634 | 🌐 Python | 📅 2026-08-27。
* [Metabase](https://metabase.com/) - [开源](https://github.com/metabase/metabase) ⭐ 48,966 | 🐛 4,475 | 🌐 Clojure | 📅 2026-08-27，跟 Redash、Superset 对比后，选用了这个。
...
* [Sequel Ace](https://sequel-ace.com/) - MySQL/MariaDB 图形工具，Sequel Pro 停止维护后， fork 出来继续维护的版本，[开源](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,516 | 🐛 174 | 🌐 Objective-C | 📅 2026-08-25。
...
* [man-group/ArcticDB](https://github.com/man-group/arcticdb) ⭐ 2,493 | 🐛 330 | 🌐 C++ | 📅 2026-08-27
...
* [scrcpy](https://github.com/Genymobile/scrcpy) ⭐ 148,390 | 🐛 2,883 | 🌐 C | 📅 2026-08-17 - Android 设备管理工具。
* [nvm](https://github.com/nvm-sh/nvm) ⭐ 94,767 | 🐛 397 | 🌐 Shell | 📅 2026-08-18 - Node.js 版本管理工具。
* [starship](https://starship.rs/) - 不错的 shell 提示符，用过一段时间，后来换到了 [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,982 | 🐛 150 | 🌐 Shell | 📅 2026-08-15。
* [wrk](https://github.com/wg/wrk) ⭐ 40,396 | 🐛 203 | 🌐 C | 📅 2023-12-30 - HTTP 压力测试。
* [DevDocs](https://devdocs.io/) - API 文档查看工具，[开源](https://github.com/freeCodeCamp/devdocs) ⭐ 39,381 | 🐛 215 | 🌐 Ruby | 📅 2026-08-26。
* [hyperfine](https://github.com/sharkdp/hyperfine) ⭐ 28,751 | 🐛 96 | 🌐 Rust | 📅 2026-04-30 - 命令行基准测试工具，测试不同命令的性能。
...
* [asdf](https://github.com/asdf-vm/asdf) ⭐ 25,549 | 🐛 152 | 🌐 Go | 📅 2026-08-27 - 支持多种语言的版本管理工具。
...
* [cloc](https://github.com/AlDanial/cloc) ⭐ 23,471 | 🐛 26 | 🌐 Perl | 📅 2026-08-08 - 代码统计工具。
* [hey](https://github.com/rakyll/hey) ⭐ 20,242 | 🐛 189 | 🌐 Go | 📅 2026-01-10 - HTTP 压力测试工具。
* [SwiftLint](https://github.com/realm/SwiftLint) ⭐ 19,713 | 🐛 495 | 🌐 Swift | 📅 2026-08-26 - Swift lint 工具。
* [n](https://github.com/tj/n) ⭐ 19,510 | 🐛 4 | 🌐 Shell | 📅 2026-08-22 - Node.js 版本管理工具。
* [golangci-lint](https://github.com/golangci/golangci-lint) ⭐ 19,322 | 🐛 122 | 🌐 Go | 📅 2026-08-27 - Go lint 工具。
...
* [direnv](https://github.com/direnv/direnv) ⭐ 15,400 | 🐛 463 | 🌐 Go | 📅 2026-03-31 - 根据目录自动设置环境变量。
* [Carthage](https://github.com/Carthage/Carthage) ⭐ 15,166 | 🐛 216 | 🌐 Swift | 📅 2025-09-10 - Objective-C 和 Swift 的依赖管理。
* [Tokei](https://github.com/XAMPPRocky/tokei) ⭐ 14,855 | 🐛 243 | 🌐 Rust | 📅 2026-05-06 - 代码统计工具。
* [webhook](https://github.com/adnanh/webhook) ⭐ 12,094 | 🐛 126 | 🌐 Go | 📅 2026-08-05 - 方便的创建 webhook endpoints，自己基于这个实现了 GitLab 和 Jira 的 bot。
* [npm-check-updates](https://github.com/raineorshine/npm-check-updates) ⭐ 10,304 | 🐛 55 | 🌐 TypeScript | 📅 2026-08-26 - npm 依赖更新检查工具。
* [scc](https://github.com/boyter/scc/) ⭐ 8,667 | 🐛 25 | 🌐 Go | 📅 2026-08-27 - 代码统计工具。
...
* [hstr](https://github.com/dvorka/hstr) ⭐ 4,455 | 🐛 185 | 🌐 C | 📅 2026-08-26 - 模糊查找 history 的工具，应该用 fzf 替代。
* [Ansible Molecule](https://github.com/ansible-community/molecule) ⭐ 4,133 | 🐛 78 | 🌐 Python | 📅 2026-08-27 - Ansible 开发/测试工具，非常好用。
* [Ansible Lint](https://github.com/ansible/ansible-lint) ⭐ 3,902 | 🐛 111 | 🌐 Python | 📅 2026-08-27 - Ansible playbook lint 工具。
* [git-subrepo](https://github.com/ingydotnet/git-subrepo) ⭐ 3,611 | 🐛 201 | 🌐 Shell | 📅 2026-02-09
* [copier](https://github.com/copier-org/copier) ⭐ 3,545 | 🐛 147 | 🌐 Python | 📅 2026-08-25 - Library and command-line utility for rendering projects templates. `Jinja2`
...
* [python-language-server](https://github.com/palantir/python-language-server) ⭐ 2,698 | 🐛 188 | 🌐 Python | 📅 2026-07-06 - Python 的 [Language Server Protocol](https://github.com/Microsoft/language-server-protocol) ⭐ 12,997 | 🐛 298 | 🌐 HTML | 📅 2026-08-26 实现。
* [loc](https://github.com/cgag/loc) ⭐ 2,458 | 🐛 64 | 🌐 Rust | 📅 2024-04-21 - 代码统计工具。
* [codespell](https://github.com/codespell-project/codespell) ⭐ 2,416 | 🐛 266 | 🌐 Python | 📅 2026-08-27 - 代码拼写检查。
...
* [gchq/CyberChef](https://github.com/gchq/CyberChef) ⭐ 35,683 | 🐛 555 | 🌐 JavaScript | 📅 2026-08-27 - The Cyber Swiss Army Knife - a web app for encryption, encoding, compression and data analysis
* [veler/DevToys](https://github.com/veler/DevToys) ⭐ 31,902 | 🐛 338 | 🌐 C# | 📅 2026-02-25 - A Swiss Army knife for developers.
...
* [massCodeIO/massCode](https://github.com/massCodeIO/massCode) ⭐ 6,964 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-27 - A free and open source code snippets manager for developers
* [knqyf263/pet](https://github.com/knqyf263/pet) ⭐ 5,336 | 🐛 29 | 🌐 Go | 📅 2026-03-13 - Simple command-line snippet manager, written in Go.
...
* [dive](https://github.com/wagoodman/dive) ⭐ 54,506 | 🐛 212 | 🌐 Go | 📅 2025-12-15 - Docker 镜像分析工具，查看各层的信息。
* [lazydocker](https://github.com/jesseduffield/lazydocker) ⭐ 52,635 | 🐛 297 | 🌐 Go | 📅 2026-04-19 - 终端下的 Docker GUI。
* [trivy](https://github.com/aquasecurity/trivy) ⭐ 37,658 | 🐛 261 | 🌐 Go | 📅 2026-08-27 - Docker 镜像安全检测工具。
...
* [CotEditor](https://coteditor.com/) - 文本编辑器，[开源](https://github.com/coteditor/CotEditor) ⭐ 8,415 | 🐛 17 | 🌐 Swift | 📅 2026-08-27。
...
* [gocryptfs](https://github.com/rfjakob/gocryptfs) ⭐ 4,583 | 🐛 73 | 🌐 Go | 📅 2026-07-22 - Encrypted overlay filesystem written in Go
...
* [nnn](https://github.com/jarun/nnn) ⭐ 21,837 | 🐛 4 | 🌐 C | 📅 2026-08-26 - 终端下的文件管理器。
...
* [organize](https://github.com/tfeldmann/organize) ⭐ 3,122 | 🐛 77 | 🌐 Python | 📅 2026-08-24 - 文件自动处理工具，类似 Hazel，我已经逐渐拿来替换 Hazel。
...
* [croc](https://github.com/schollz/croc) ⭐ 40,118 | 🐛 3 | 🌐 Go | 📅 2026-08-27 - 非常方便的临时文件传输工具，推荐。
* [Magic Wormhole](https://github.com/warner/magic-wormhole) ⭐ 22,887 | 🐛 182 | 🌐 Python | 📅 2026-08-27 - 文件传输，类似的还有 croc。
...
* [Watchman](https://github.com/facebook/watchman) ⭐ 13,695 | 🐛 258 | 🌐 C++ | 📅 2026-08-27
* [watchdog](https://github.com/gorakhargosh/watchdog) ⭐ 7,399 | 🐛 241 | 🌐 Python | 📅 2026-08-26 - Python 实现的，开源当包用，同时提供一个 watchmedo 的命令行工具。
* [watchexec](https://github.com/watchexec/watchexec) ⭐ 7,142 | 🐛 28 | 🌐 Rust | 📅 2026-08-24
* [entr](http://eradman.com/entrproject/) - 文件变化监控工具，[开源](https://github.com/eradman/entr) ⭐ 5,660 | 🐛 1 | 🌐 C | 📅 2026-06-27。
...
* [Beancount](http://furius.ca/beancount/) - [开源](https://github.com/beancount/beancount) ⭐ 5,946 | 🐛 236 | 🌐 Python | 📅 2026-08-23 复式记账软件，强烈推荐。
...
* [Fira Code](https://github.com/tonsky/FiraCode) ⭐ 81,952 | 🐛 428 | 🌐 Clojure | 📅 2026-07-28
* [Fira Code Nerd Font](https://github.com/ryanoasis/nerd-fonts) ⭐ 64,435 | 🐛 18 | 🌐 CSS | 📅 2026-08-22
* [Hack Nerd Font](https://github.com/ryanoasis/nerd-fonts) ⭐ 64,435 | 🐛 18 | 🌐 CSS | 📅 2026-08-22
* [Meslo Nerd Font](https://github.com/ryanoasis/nerd-fonts) ⭐ 64,435 | 🐛 18 | 🌐 CSS | 📅 2026-08-22
...
* [gomplate](https://github.com/hairyhenderson/gomplate) ⭐ 3,202 | 🐛 19 | 🌐 Go | 📅 2026-08-26 - A flexible commandline tool for template rendering. Supports lots of local and remote datasources.
...
* [lazygit](https://github.com/jesseduffield/lazygit) ⭐ 81,700 | 🐛 1,022 | 🌐 Go | 📅 2026-08-27 - 终端下的 Git GUI。
* [git-delta](https://github.com/dandavison/delta) ⭐ 31,879 | 🐛 429 | 🌐 Rust | 📅 2026-08-02 - git diff 加强。
* [GitUI](https://github.com/extrawurst/gitui) ⭐ 22,438 | 🐛 343 | 🌐 Rust | 📅 2026-08-04 - 终端下的 Git GUI。
* [git-extras](https://github.com/tj/git-extras) ⭐ 18,097 | 🐛 95 | 🌐 Shell | 📅 2026-08-27 - Git 的一些加强。
* [git-secrets](https://github.com/awslabs/git-secrets) ⭐ 13,383 | 🐛 131 | 🌐 Shell | 📅 2025-09-17 - Git 文件加密。
* [Tig](https://github.com/jonas/tig) ⭐ 13,318 | 🐛 232 | 🌐 C | 📅 2026-07-27 - 终端下的 Git GUI。
* [bfg](https://rtyley.github.io/bfg-repo-cleaner/) - Git 仓库历史清理工具，[开源](https://github.com/rtyley/bfg-repo-cleaner) ⭐ 12,177 | 🐛 275 | 🌐 Scala | 📅 2025-01-19。
* [GitUp](https://gitup.co/) - Git GUI，[开源](https://github.com/git-up/GitUp) ⭐ 12,111 | 🐛 365 | 🌐 Objective-C | 📅 2026-07-27。
* [onefetch](https://github.com/o2sh/onefetch) ⭐ 12,035 | 🐛 63 | 🌐 Rust | 📅 2026-08-26 - 漂亮的 Git 仓库信息统计。
* [git-crypt](https://github.com/AGWA/git-crypt) ⭐ 9,872 | 🐛 128 | 🌐 C++ | 📅 2025-09-24 - Git 文件加密。
...
* [git-secret](https://github.com/sobolevn/git-secret) ⭐ 4,038 | 🐛 153 | 🌐 Shell | 📅 2026-08-24 - Git 文件加密。
* [ghq](https://github.com/x-motemen/ghq) ⭐ 3,759 | 🐛 42 | 🌐 Go | 📅 2026-08-24 - Git 仓库管理工具，仓库多时很好用。
* [git-chglog](https://github.com/git-chglog/git-chglog) ⚠️ Archived - 基于 Git 的 CHANGELOG 生成工具。
* [Gita](https://github.com/nosarthur/gita) ⭐ 1,930 | 🐛 36 | 🌐 Python | 📅 2026-07-06 - 多 Git 仓库管理工具。
...
* [act](https://github.com/nektos/act) ⭐ 71,668 | 🐛 368 | 🌐 Go | 📅 2026-08-09 - 在本地执行 GitHub Actions，我之前用来开发 GitHub Actions。
* [gh](https://github.com/cli/cli) ⭐ 46,024 | 🐛 1,067 | 🌐 Go | 📅 2026-08-27 - GitHub CLI.
* [grip](https://github.com/joeyespo/grip) ⭐ 6,825 | 🐛 125 | 🌐 Python | 📅 2024-07-10 - GitHub Readme 预览工具。
* [Gitify](https://www.gitify.io/) - GitHub 通知工具，[开源](https://github.com/manosim/gitify) ⭐ 5,334 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-26。
...
* [puppeteer](https://github.com/puppeteer/puppeteer) ⭐ 95,512 | 🐛 264 | 🌐 TypeScript | 📅 2026-08-26 - Headless Chrome Node.js API
* [phantomjs](https://github.com/ariya/phantomjs) ⚠️ Archived - Scriptable Headless Browser
* [appium](https://github.com/appium/appium) ⭐ 21,903 | 🐛 63 | 🌐 TypeScript | 📅 2026-08-25 - Automation for iOS, Android, and Windows Apps.
* [AutoHotkey\_L](https://github.com/Lexikos/AutoHotkey_L) ⭐ 13,020 | 🐛 22 | 🌐 C++ | 📅 2026-08-16 - AutoHotkey - macro-creation and automation-oriented scripting utility for Windows.
...
* [pywinauto](https://github.com/pywinauto/pywinauto) ⭐ 6,151 | 🐛 536 | 🌐 Python | 📅 2026-05-23 - Windows GUI Automation with Python (based on text properties)
...
* [imgproxy/imgproxy](https://github.com/imgproxy/imgproxy) ⭐ 11,031 | 🐛 69 | 🌐 Go | 📅 2026-08-27 - Fast and secure standalone server for resizing and converting remote images
  ...
  * [benchmark](https://github.com/imgproxy/imgproxy/blob/master/BENCHMARK.md) ⭐ 11,031 | 🐛 69 | 🌐 Go | 📅 2026-08-27
  * [cshum/imagor](https://github.com/cshum/imagor) ⭐ 4,012 | 🐛 3 | 🌐 Go | 📅 2026-08-27 - Fast, secure image processing server and Go library, using libvips
  ...
  * [imazen/imageflow](https://github.com/imazen/imageflow) ⭐ 4,412 | 🐛 24 | 🌐 Rust | 📅 2026-08-27 - High-performance image manipulation for web servers. Includes imageflow\_server, imageflow\_tool, and libimageflow
  ...
  * [webp-sh/webp\_server\_go](https://github.com/webp-sh/webp_server_go) ⭐ 2,007 | 🐛 1 | 🌐 Go | 📅 2026-08-27 - A tool that will serve your JPG/PNG/BMP/SVGs as WebP/AVIF format with compression, on-the-fly.
...
* [sjlleo/nexttrace](https://github.com/sjlleo/nexttrace) ⭐ 8,124 | 🐛 0 | 🌐 Go | 📅 2026-08-23 - An open source visual route tracking CLI tool
...
* [nitefood/asn](https://github.com/nitefood/asn) ⭐ 1,926 | 🐛 4 | 🌐 Shell | 📅 2026-06-22 - ASN / RPKI validity / BGP stats / IPv4v6 / Prefix / URL / ASPath / Organization / IP reputation / IP geolocation / IP fingerprinting / Network recon / lookup API server / Web traceroute server
...
* [Kubernetes](https://github.com/kubernetes/kubernetes) ⭐ 125,303 | 🐛 2,969 | 🌐 Go | 📅 2026-08-27
* [k3s](https://github.com/k3s-io/k3s) ⭐ 33,836 | 🐛 72 | 🌐 Go | 📅 2026-08-27
* [Minikube](https://github.com/kubernetes/minikube) ⭐ 32,071 | 🐛 543 | 🌐 Go | 📅 2026-08-26
...
* [MicroK8s](https://github.com/canonical/microk8s) ⭐ 9,359 | 🐛 166 | 🌐 Python | 📅 2026-08-27
* [k0s](https://github.com/k0sproject/k0s) ⭐ 6,454 | 🐛 205 | 🌐 Go | 📅 2026-08-27
* [KubeOperator](https://kubeoperator.io/)

### Utils

* [derailed/k9s](https://github.com/derailed/k9s) ⭐ 34,453 | 🐛 98 | 🌐 Go | 📅 2026-08-25 - Kubernetes CLI To Manage Your Clusters In Style!
* [k3sup](https://github.com/alexellis/k3sup) ⭐ 7,424 | 🐛 32 | 🌐 Go | 📅 2026-08-19 - bootstrap K3s over SSH in < 60s 🚀
* [stern](https://github.com/stern/stern) ⭐ 4,849 | 🐛 41 | 🌐 Go | 📅 2026-08-19 - Kubernetes 日志查看工具。
...
* [acme.sh](https://github.com/acmesh-official/acme.sh) ⭐ 47,547 | 🐛 104 | 🌐 Shell | 📅 2026-08-22
...
* [Glow](https://github.com/charmbracelet/glow) ⭐ 27,086 | 🐛 225 | 🌐 Go | 📅 2026-08-16 - 命令行下的 Markdown 查看/渲染工具。
...
* [Downie](https://software.charliemonroe.net/downie/) - 视频下载工具，类似 [youtube-dl](https://github.com/ytdl-org/youtube-dl) ⭐ 141,038 | 🐛 4,126 | 🌐 Python | 📅 2026-02-19。
* [You-Get](https://github.com/soimort/you-get) ⭐ 56,871 | 🐛 386 | 🌐 Python | 📅 2026-08-24 - 视频下载工具。
* [IINA](https://iina.io/) - 视频播放器，[开源](https://github.com/iina/iina) ⭐ 46,104 | 🐛 1,917 | 🌐 Swift | 📅 2026-08-26，我记得是基于 mpv 的。
* [mpv](https://mpv.io/) - 视频播放器，[开源](https://github.com/mpv-player/mpv) ⭐ 36,705 | 🐛 1,139 | 🌐 C | 📅 2026-08-26，曾经花了很大精力去配置，后来换到了 IINA。
* [Annie](https://github.com/iawia002/annie) ⭐ 31,654 | 🐛 544 | 🌐 Go | 📅 2026-03-29 - 视频下载工具。
* [gallery-dl](https://github.com/mikf/gallery-dl) ⭐ 19,336 | 🐛 1,149 | 🌐 Python | 📅 2026-08-01 - 相册服务下载工具。
...
* [Komet/MediaElch](https://github.com/Komet/MediaElch) ⭐ 1,101 | 🐛 310 | 🌐 C++ | 📅 2026-08-25
...
* [Netdata](https://www.netdata.cloud/) - [开源](https://github.com/netdata/netdata) ⭐ 80,324 | 🐛 387 | 🌐 Go | 📅 2026-08-27 监控系统。
* [Stats](https://github.com/exelban/stats) ⭐ 41,469 | 🐛 24 | 🌐 Swift | 📅 2026-08-27 - 开源的系统监控工具，类似 iStat Menus。
* [bandwhich](https://github.com/imsnif/bandwhich) ⭐ 11,925 | 🐛 55 | 🌐 Rust | 📅 2026-08-01 - 流量查看工具。
...
* [netsage-project/grafana-dashboard-manager](https://github.com/netsage-project/grafana-dashboard-manager) ⭐ 427 | 🐛 14 | 🌐 Go | 📅 2026-08-27 - Grafana Dashboard Manager
...
* [ClementTsang/bottom](https://github.com/clementtsang/bottom) ⭐ 13,942 | 🐛 107 | 🌐 Rust | 📅 2026-08-27 - Yet another cross-platform graphical process/system monitor.
* [aristocratos/bashtop](https://github.com/aristocratos/bashtop) ⭐ 11,118 | 🐛 64 | 🌐 Shell | 📅 2023-08-21 - Linux/OSX/FreeBSD resource monitor
* [aristocratos/bpytop](https://github.com/aristocratos/bpytop) ⭐ 10,923 | 🐛 99 | 🌐 Python | 📅 2025-06-01 - Linux/OSX/FreeBSD resource monitor
...
* [facebookincubator/below](https://github.com/facebookincubator/below) ⭐ 2,493 | 🐛 31 | 🌐 Rust | 📅 2026-08-26 - A time traveling resource monitor for modern Linux systems
* [ytop](https://github.com/cjbassi/ytop) ⚠️ Archived - Rust 写的系统监控工具，类似 top、htop，不维护了。
* [Atoptool/atop](https://github.com/Atoptool/atop) ⭐ 1,054 | 🐛 62 | 🌐 C | 📅 2026-08-15 - System and process monitor for Linux
* [Glances](https://nicolargo.github.io/glances/) - 系统监控，类似 top/htop。
* [nmon and njmon](https://nmon.sourceforge.io/pmwiki.php)

## Music

* [navidrome/navidrome](https://github.com/navidrome/navidrome) ⭐ 23,153 | 🐛 276 | 🌐 Go | 📅 2026-08-27 - 🎧☁️ Modern Music Server and Streamer compatible with Subsonic/Airsonic
* [Spotify TUI](https://github.com/Rigellute/spotify-tui) ⭐ 19,324 | 🐛 306 | 🌐 Rust | 📅 2024-04-04 - Rust 写的终端下的 Spotify 客户端。
* [sonic-pi-net/sonic-pi](https://github.com/sonic-pi-net/sonic-pi) ⭐ 12,081 | 🐛 25 | 🌐 C++ | 📅 2026-08-12 - Code. Music. Live.
* [mopidy/mopidy](https://github.com/mopidy/mopidy) ⭐ 8,563 | 🐛 225 | 🌐 Python | 📅 2026-08-20 - Mopidy is an extensible music server written in Python
* [harmonoid/harmonoid](https://github.com/harmonoid/harmonoid) ⭐ 4,713 | 🐛 89 | 🌐 Dart | 📅 2026-08-26 - 🎵 Plays & manages your music library. Looks beautiful & juicy. Playlists, visuals, synced lyrics, pitch shift, volume boost & more.
* [sentriz/gonic](https://github.com/sentriz/gonic) ⭐ 2,518 | 🐛 71 | 🌐 Go | 📅 2026-08-27 - music streaming server / subsonic server API implementation
...
* [Motrix](https://motrix.app/) - 下载工具，基于 aria2，[开源](https://github.com/agalwood/Motrix) ⭐ 54,682 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-27。
...
* [AriaNg](https://github.com/mayswind/AriaNg) ⭐ 13,173 | 🐛 20 | 🌐 JavaScript | 📅 2026-06-21 - aria2 的 Web 管理工具
  * [AriaNg Native](https://github.com/mayswind/AriaNg-Native) ⭐ 2,716 | 🐛 3 | 🌐 JavaScript | 📅 2026-06-21 - 基于 [Electron](https://github.com/electron/electron) ⭐ 122,753 | 🐛 758 | 🌐 C++ | 📅 2026-08-27 实现的 AriaNg 桌面版。
* [iperf3](https://github.com/esnet/iperf) ⭐ 8,719 | 🐛 233 | 🌐 C | 📅 2026-07-10 - 带宽测试工具。
* [Hackl0us/GeoIP2-CN](https://github.com/Hackl0us/GeoIP2-CN) ⭐ 7,409 | 🐛 32 | 🌐 Go | 📅 2026-08-25 - 最小巧、最准确、最实用的 中国大陆 IP 段 + GeoIP2 数据库。
* [Unbound](https://github.com/NLnetLabs/unbound) ⭐ 4,822 | 🐛 378 | 🌐 C | 📅 2026-08-26 - DNS 服务器，之前拿来在本机跑了一个优化的。
...
* [axel](https://github.com/axel-download-accelerator/axel) ⭐ 3,396 | 🐛 88 | 🌐 C | 📅 2026-08-27 - 多线程下载工具。
...
* [Joplin](https://joplinapp.org/) - 笔记工具，[开源](https://github.com/laurent22/joplin) ⭐ 56,131 | 🐛 631 | 🌐 TypeScript | 📅 2026-08-27。
...
* [novuhq/novu](https://github.com/novuhq/novu) ⭐ 39,679 | 🐛 106 | 🌐 TypeScript | 📅 2026-08-27 - `支持众多服务` The open-source notifications infrastructure. A fully-featured microservice to send SMS, E-mail, Slack and Push notifications. Embeddable notification center for React with real-time updates, content management, and much more...
* [binwiederhier/ntfy](https://github.com/binwiederhier/ntfy) ⭐ 33,792 | 🐛 369 | 🌐 Go | 📅 2026-08-27 - `支持 Web APP、iOS、macOS` Send push notifications to your phone or desktop using PUT/POST
* [caronc/apprise](https://github.com/caronc/apprise) ⭐ 17,195 | 🐛 30 | 🌐 Python | 📅 2026-08-27 - `支持众多服务` Push Notifications that work with just about every platform!
* [Finb/Bark](https://github.com/Finb/Bark) ⭐ 8,949 | 🐛 5 | 🌐 Swift | 📅 2026-08-18 - `支持 iOS` Bark is an iOS App which allows you to push custom notifications to your iPhone
...
* [gopass](https://github.com/gopasspw/gopass) ⭐ 7,108 | 🐛 87 | 🌐 Go | 📅 2026-08-26 - 命令行下的密码管理工具。
...
* [Etherpad](https://etherpad.org/) - [ether/etherpad-lite](https://github.com/ether/etherpad-lite) ⭐ 18,508 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-27
* [PrivateBin](https://privatebin.info/) - [PrivateBin/PrivateBin](https://github.com/PrivateBin/PrivateBin) ⭐ 8,571 | 🐛 220 | 🌐 PHP | 📅 2026-08-26
* [CryptPad](https://cryptpad.fr/) - [xwiki-labs/cryptpad](https://github.com/xwiki-labs/cryptpad) ⭐ 7,865 | 🐛 390 | 🌐 JavaScript | 📅 2026-08-27
...
* [Nukesor/pueue](https://github.com/Nukesor/pueue) ⭐ 6,305 | 🐛 21 | 🌐 Rust | 📅 2026-08-16 - Manage your shell commands.
...
* [DarthSim/overmind](https://github.com/DarthSim/overmind) ⭐ 3,731 | 🐛 60 | 🌐 Go | 📅 2025-04-04 - Process manager for Procfile-based applications and tmux
...
* [brendangregg/FlameGraph](https://github.com/brendangregg/FlameGraph) ⭐ 19,701 | 🐛 174 | 🌐 Perl | 📅 2024-10-20 - Stack trace visualizer
...
* [benfred/py-spy](https://github.com/benfred/py-spy) ⭐ 15,450 | 🐛 238 | 🌐 Rust | 📅 2026-08-14 - Sampling profiler for Python programs
* [plasma-umass/scalene](https://github.com/plasma-umass/scalene) ⭐ 13,495 | 🐛 154 | 🌐 Python | 📅 2026-08-01 - a high-performance, high-precision CPU, GPU, and memory profiler for Python
...
* [wiretrustee/wiretrustee](https://github.com/wiretrustee/wiretrustee) ⭐ 28,687 | 🐛 1,577 | 🌐 Go | 📅 2026-08-27 - Connect your devices into a single secure private WireGuard®-based mesh network.
* [hwdsl2/setup-ipsec-vpn](https://github.com/hwdsl2/setup-ipsec-vpn) ⭐ 28,393 | 🐛 2 | 🌐 Shell | 📅 2026-08-27 - Scripts to build your own IPsec VPN server, with IPsec/L2TP, Cisco IPsec and IKEv2
* [slackhq/nebula](https://github.com/slackhq/nebula) ⭐ 17,660 | 🐛 101 | 🌐 Go | 📅 2026-08-27 - A scalable overlay networking tool with a focus on performance, simplicity and security
* [zerotier/ZeroTierOne](https://github.com/zerotier/ZeroTierOne) ⭐ 17,050 | 🐛 397 | 🌐 C++ | 📅 2026-08-03 - A Smart Ethernet Switch for Earth
...
* [firezone/firezone](https://github.com/firezone/firezone) ⭐ 9,043 | 🐛 397 | 🌐 Elixir | 📅 2026-08-27 - WireGuard-based VPN server and firewall
...
* [3proxy](https://github.com/z3APA3A/3proxy) ⭐ 5,425 | 🐛 33 | 🌐 C | 📅 2026-08-27
...
* [blackmatrix7/ios\_rule\_script](https://github.com/blackmatrix7/ios_rule_script) ⭐ 27,679 | 🐛 376 | 🌐 JavaScript | 📅 2026-08-25 - 除了整合各个开源的规则/脚本，也有很多特有的，大而全。
...
* [pyenv](https://github.com/pyenv/pyenv) ⭐ 45,050 | 🐛 55 | 🌐 Shell | 📅 2026-08-26 - Python 版本管理工具。
* [wtfpython](https://github.com/satwikkansal/wtfpython) ⭐ 37,067 | 🐛 72 | 🌐 Python | 📅 2026-01-13 - What the f\*ck Python!
* [Pipenv](https://github.com/pypa/pipenv) ⭐ 25,035 | 🐛 12 | 🌐 Python | 📅 2026-08-24 - Python 虚拟环境管理工具。
* [Mypy](https://github.com/python/mypy) ⭐ 20,614 | 🐛 3,203 | 🌐 Python | 📅 2026-08-27 - Python 静态类型检查工具。
* [pipx](https://github.com/pipxproject/pipx) ⭐ 12,948 | 🐛 0 | 🌐 Python | 📅 2026-08-25 - 安装 Python 写的命令行工具的神器。
...
* [python-gitlab](https://github.com/python-gitlab/python-gitlab) ⭐ 2,472 | 🐛 31 | 🌐 Python | 📅 2026-08-27 - Python 封装的 GitLab API，同时也是 GitLab 的 CLI 工具。
...
* [black](https://github.com/psf/black) ⭐ 41,819 | 🐛 303 | 🌐 Python | 📅 2026-08-20
* [YAPF](https://github.com/google/yapf) ⭐ 13,981 | 🐛 417 | 🌐 Python | 📅 2026-08-21
...
* [GitPython](https://github.com/gitpython-developers/GitPython) ⭐ 5,175 | 🐛 12 | 🌐 Python | 📅 2026-08-25 - GitPython is a python library used to interact with Git repositories.
...
* [grex](https://github.com/pemistahl/grex) ⭐ 8,175 | 🐛 18 | 🌐 Rust | 📅 2026-02-27 - 正则生成工具。
...
* [robotframework](https://github.com/robotframework/robotframework) ⭐ 11,847 | 🐛 300 | 🌐 Python | 📅 2026-08-26
...
* [NetNewsWire](https://ranchero.com/netnewswire/) - 多平台 RSS 阅读工具，但是支持的服务比较少，[开源](https://github.com/Ranchero-Software/NetNewsWire) ⭐ 10,322 | 🐛 618 | 🌐 Swift | 📅 2026-08-27。
* [Miniflux](https://miniflux.app/) - [开源](https://github.com/miniflux/v2) ⭐ 9,618 | 🐛 279 | 🌐 Go | 📅 2026-08-24 RSS 阅读服务。
...
* [MASSCAN](https://github.com/robertdavidgraham/masscan/) ⭐ 25,957 | 🐛 414 | 🌐 C | 📅 2026-04-23 - 端口快速扫描工具。
* [Ciphey](https://github.com/Ciphey/Ciphey) ⭐ 21,582 | 🐛 2 | 🌐 Rust | 📅 2026-08-26 - 使用自然语言处理和人工智能以及一些全自动解密/解码/破解工具。
* [JD-GUI](https://java-decompiler.github.io/) - Java 反编译工具，[开源](https://github.com/java-decompiler/jd-gui) ⭐ 15,180 | 🐛 248 | 🌐 Java | 📅 2024-07-08。
* [OWASP Amass](https://github.com/OWASP/Amass) ⭐ 15,052 | 🐛 238 | 🌐 Go | 📅 2026-07-19 - 安全测试信息收集工具。
* [hydra](https://github.com/vanhauser-thc/thc-hydra) ⭐ 12,203 | 🐛 49 | 🌐 C | 📅 2026-07-30 - 密码破解。
* [YARA](https://github.com/VirusTotal/yara/) ⭐ 9,833 | 🐛 170 | 🌐 C | 📅 2026-08-25 - 恶意软件查找。
* [objection](https://github.com/sensepost/objection) ⭐ 9,349 | 🐛 55 | 🌐 Python | 📅 2026-07-23 - 基于 [Frida](https://frida.re/) 实现的移动端安全测试辅助工具。
...
* [xxh-xxh](https://github.com/xxh/xxh) ⭐ 6,076 | 🐛 30 | 🌐 Python | 📅 2026-06-02 - 把本地的 shell 通过 SSH 带到远程服务器。
...
* [assh](https://github.com/moul/assh) ⭐ 3,218 | 🐛 100 | 🌐 Go | 📅 2026-08-27 - SSH 客户端加强。
...
* [celery/celery](https://github.com/celery/celery) ⭐ 28,828 | 🐛 753 | 🌐 Python | 📅 2026-08-27 - Distributed Task Queue (development branch)
* [rq/rq](https://github.com/rq/rq) ⭐ 10,671 | 🐛 253 | 🌐 Python | 📅 2026-08-24 - Simple job queues for Python
* [hatchet-dev/hatchet](https://github.com/hatchet-dev/hatchet) ⭐ 7,799 | 🐛 134 | 🌐 Go | 📅 2026-08-27 - A distributed, fault-tolerant task queue
* [coleifer/huey](https://github.com/coleifer/huey) ⭐ 6,014 | 🐛 0 | 🌐 Python | 📅 2026-08-16 - a little task queue for python
* [Bogdanp/dramatiq](https://github.com/Bogdanp/dramatiq) ⭐ 5,309 | 🐛 63 | 🌐 Python | 📅 2026-08-13 - A fast and reliable background task processing library for Python 3
...
* [Terminus](https://eugeny.github.io/terminus/) - 终端模拟器，[开源](https://github.com/Eugeny/terminus) ⭐ 74,171 | 🐛 2,868 | 🌐 TypeScript | 📅 2026-08-24。
* [alacritty](https://github.com/alacritty/alacritty) ⭐ 65,534 | 🐛 339 | 🌐 Rust | 📅 2026-08-26 - A cross-platform, OpenGL terminal emulator.
* [tmux](https://github.com/tmux/tmux) ⭐ 48,867 | 🐛 34 | 🌐 C | 📅 2026-08-25 - 终端复用工具。
* [Hyper](https://hyper.is/) - 终端模拟器，基于 Electron，[开源](https://github.com/vercel/hyper) ⭐ 44,706 | 🐛 1,046 | 🌐 TypeScript | 📅 2026-08-21。
* [kitty](https://github.com/kovidgoyal/kitty) ⭐ 34,631 | 🐛 11 | 🌐 Python | 📅 2026-08-27 - Cross-platform, fast, feature-rich, GPU based terminal
* [Swordfish90/cool-retro-term](https://github.com/Swordfish90/cool-retro-term) ⭐ 25,960 | 🐛 561 | 🌐 QML | 📅 2026-05-31 - A good looking terminal emulator which mimics the old cathode display...
...
* [espanso](https://espanso.org/) - Rust 写的 [开源](https://github.com/federico-terzi/espanso) ⭐ 14,369 | 🐛 535 | 🌐 Rust | 📅 2026-08-24 跨平台文字快捷输入工具，类似 [aText](https://www.trankynam.com/atext/)、[TextExpander](https://textexpander.com/)。
...
* [kevinpapst/kimai2](https://github.com/kevinpapst/kimai2) ⭐ 4,947 | 🐛 342 | 🌐 PHP | 📅 2026-08-25 - 开源可自建。
* [muety/wakapi](https://github.com/muety/wakapi) ⭐ 4,412 | 🐛 40 | 🌐 Go | 📅 2026-08-26 - 📊 A minimalist, self-hosted WakaTime-compatible backend for coding statistics. 兼容 WakaTime，可自建。
...
* [ActivityWatch](https://activitywatch.net/) - Open-source time tracker. 开源可自建。
  * [ActivityWatch/activitywatch](https://github.com/ActivityWatch/activitywatch) ⭐ 18,731 | 🐛 183 | 🌐 Python | 📅 2026-08-26 - The best free and open-source automated time tracker. Cross-platform, extensible, privacy-focused.
...
* [kutt](https://github.com/thedevs-network/kutt) ⭐ 11,061 | 🐛 80 | 🌐 JavaScript | 📅 2026-08-17 - Free Modern URL Shortener.
* [shlink](https://github.com/shlinkio/shlink) ⭐ 5,250 | 🐛 22 | 🌐 PHP | 📅 2026-08-06 - The definitive self-hosted URL shortener
* [polr](https://github.com/cydrobolt/polr) ⭐ 5,095 | 🐛 216 | 🌐 PHP | 📅 2024-05-28 - A modern, powerful, and robust URL shortener
* [zws](https://github.com/zws-im/zws) ⭐ 1,847 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-27 - Shorten URLs using invisible spaces.
...
* [YOURLS](https://yourls.org/) - Your Own URL Shortener
  * [YOURLS](https://github.com/YOURLS/YOURLS) ⭐ 12,177 | 🐛 48 | 🌐 PHP | 📅 2026-08-24

## Utilities

* [Etcher](https://www.balena.io/etcher/) - 往 U 盘写入镜像的工具，[开源](https://github.com/balena-io/etcher) ⭐ 34,243 | 🐛 688 | 🌐 TypeScript | 📅 2026-06-02。
* [PicGo](https://molunerfinn.com/PicGo/) - 支持各种图床的上传工具，基于 Electron，[开源](https://github.com/Molunerfinn/PicGo) ⭐ 27,065 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-23。
...
* [KeyCastr](https://github.com/keycastr/keycastr) ⭐ 15,070 | 🐛 89 | 🌐 Objective-C | 📅 2026-08-27 - 显示当前按键。
* [Hidden Bar](https://github.com/dwarvesf/hidden/) ⭐ 14,636 | 🐛 99 | 🌐 Swift | 📅 2026-06-15 - 开源的 Menu Bar 图标管理工具，类似 [Bartender](https://www.macbartender.com/)。
* [Pock](https://pock.dev/) - 让 Touch Bar 更有用的工具，[开源](https://github.com/pigigaldi/Pock) ⭐ 10,145 | 🐛 71 | 🌐 Swift | 📅 2022-11-12。
* [Bob](https://github.com/ripperhe/Bob) ⭐ 9,736 | 🐛 108 | 📅 2025-12-30 - macOS 下的翻译软件。
...
* [mac-cleanup](https://github.com/fwartner/mac-cleanup) ⭐ 2,819 | 🐛 8 | 🌐 Shell | 📅 2023-05-21 - for macOS 的清理脚本。
...
* [duti](https://github.com/moretension/duti/) ⭐ 2,059 | 🐛 27 | 🌐 C | 📅 2023-07-09 - macOS 下命令行管理文件关联。
...
* [ai/nanoid](https://github.com/ai/nanoid) ⭐ 26,950 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-10 - A tiny (130 bytes), secure, URL-friendly, unique string ID generator for JavaScript
* [ulid/spec](https://github.com/ulid/spec) ⭐ 10,815 | 🐛 74 | 📅 2024-07-20 - The canonical spec for ulid
...
* [plotly/plotly.py](https://github.com/plotly/plotly.py) ⭐ 18,755 | 🐛 769 | 🌐 Python | 📅 2026-08-27 - The interactive graphing library for Python (includes Plotly Express)
* [python-visualization/folium](https://github.com/python-visualization/folium) ⭐ 7,394 | 🐛 69 | 🌐 Python | 📅 2026-08-25 - Python Data. Leaflet.js Maps.
* [tidyverse/ggplot2](https://github.com/tidyverse/ggplot2) ⭐ 6,988 | 🐛 147 | 🌐 R | 📅 2026-04-22 - An implementation of the Grammar of Graphics in R
...
* [holoviz/holoviews](https://github.com/holoviz/holoviews) ⭐ 2,907 | 🐛 1,054 | 🌐 Python | 📅 2026-08-27 - With Holoviews, your data visualizes itself.
...
* [umami](https://github.com/umami-software/umami) ⭐ 38,408 | 🐛 112 | 🌐 TypeScript | 📅 2026-08-27 - Umami is a simple, fast, privacy-focused alternative to Google Analytics.
* [arp242/goatcounter](https://github.com/arp242/goatcounter) ⭐ 5,918 | 🐛 48 | 🌐 Go | 📅 2026-08-21 - Easy web analytics. No tracking of personal data.
...
* [yabai](https://github.com/koekeishiya/yabai) ⭐ 29,520 | 🐛 251 | 🌐 C | 📅 2026-06-14 - A tiling window manager for macOS based on binary space partitioning
...
* [n8n](https://github.com/n8n-io/n8n) ⭐ 202,617 | 🐛 1,097 | 🌐 TypeScript | 📅 2026-08-27 - 支持的 [服务](https://n8n.io/integrations)。
* [Huginn](https://github.com/huginn/huginn) ⭐ 49,856 | 🐛 694 | 🌐 Ruby | 📅 2026-08-27
* [windmill-labs/windmill](https://github.com/windmill-labs/windmill) ⭐ 17,703 | 🐛 836 | 🌐 Rust | 📅 2026-08-27 - Open-source developer platform to turn scripts into workflows and UIs. Fastest workflow engine (5x vs Airflow). Open-source alternative to Airplane and Retool.
* [PipedreamHQ/pipedream](https://github.com/PipedreamHQ/pipedream) ⭐ 11,651 | 🐛 4,359 | 🌐 JavaScript | 📅 2026-08-27 - Connect APIs, remarkably fast. Free for developers.
...
* [Powerlevel10k](https://github.com/romkatv/powerlevel10k) ⭐ 54,982 | 🐛 150 | 🌐 Shell | 📅 2026-08-15 - zsh theme，很好用，特别是`Instant prompt`这个特性，我从 [starship](https://starship.rs/) 转过来的。
* [zsh-autosuggestions](https://github.com/zsh-users/zsh-autosuggestions) ⭐ 36,013 | 🐛 203 | 🌐 Shell | 📅 2025-06-24
* [zsh-syntax-highlighting](https://github.com/zsh-users/zsh-syntax-highlighting) ⭐ 22,956 | 🐛 213 | 🌐 Shell | 📅 2026-08-22
...
* [Zinit](https://github.com/zdharma-continuum/zinit) ⭐ 4,816 | 🐛 114 | 🌐 Shell | 📅 2026-08-27 - zsh 插件管理工具，很好用，特别是`Turbo Mode`这个特性，[Antibody](https://github.com/getantibody/antibody) ⚠️ Archived 转过来的。
* [zsh-history-substring-search](https://github.com/zsh-users/zsh-history-substring-search) ⭐ 3,093 | 🐛 46 | 🌐 Shell | 📅 2026-01-15
* [Antibody](https://github.com/getantibody/antibody) ⚠️ Archived - zsh 插件管理工具，用过一段时间，后来换 [Zinit](https://github.com/zdharma-continuum/zinit) ⭐ 4,816 | 🐛 114 | 🌐 Shell | 📅 2026-08-27 了。
